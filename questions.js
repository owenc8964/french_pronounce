...
const BANK = [
  ...
  // ══════════ 第27課：所有格代名詞 · futur simple · 科技創新 · 性格補完 ══════════
  { lesson:27, topic:'pronoms-possessifs', type:'choose', q:'所有格代名詞（le mien）跟所有格形容詞（mon）最大的差別是？', hint:'老師用 my / mine 解釋的', a:'形容詞後面一定接名詞，代名詞後面什麼都不接', aNote:'⭐ 就是英文 my shoes（要說出東西）vs it\'s mine（不說東西）。<b>mon appareil → le mien</b>，名詞被代名詞吃掉了', opts:['形容詞後面一定接名詞，代名詞後面什麼都不接','代名詞只能用在問句','形容詞才要配合性數','兩個完全一樣'] },
  { lesson:27, topic:'pronoms-possessifs', type:'choose', q:'一個男生講「他的照片」，為什麼是 la sienne 不是 le sien？', hint:'配合的對象是誰', a:'因為配合的是 photo（陰性），不是擁有者的性別', aNote:'⭐⭐ 這是整課最容易錯的一條：<b>所有格代名詞跟著「被代替的名詞」走，不跟著人走</b>。sa photo（陰性）→ la sienne', opts:['因為配合的是 photo（陰性），不是擁有者的性別','因為 sien 沒有陽性形','因為主詞是 il','因為照片是別人拍的'] },
  { lesson:27, topic:'pronoms-possessifs', type:'fill', q:'Ton appareil photo est en panne ? Prends _____.（拿我的）', hint:'appareil 陽性單數', a:'le mien', aNote:'appareil 是陽性單數 → <b>le mien</b>。⚠️ 一定要帶定冠詞，不能只說 mien' },
  { lesson:27, topic:'pronoms-possessifs', type:'fill', q:"J'ai préparé ma photo. Et toi ? Tu as apporté _____ ?（你的那張）", hint:'photo 陰性單數、對象是 tu', a:'la tienne', aNote:'photo 陰性 → la tienne。⚠️ 不是 le tien' },
  { lesson:27, topic:'pronoms-possessifs', type:'fill', q:"Si je n'ai pas de caméra, ils me laissent utiliser _____.（他們的那台）", hint:'caméra 陰性單數、擁有者是 ils', a:'la leur', aNote:'⭐ ils ＋ 陰性單數 → <b>la leur</b>。leur 這一行不加帽子' },
  { lesson:27, topic:'pronoms-possessifs', type:'fill', q:"J'ai rempli mon quadrant. Vous avez terminé _____ ?（您的那個）", hint:'quadrant 陽性、對象是 vous', a:'le vôtre', aNote:'⚠️ 代名詞 <b>le vôtre 有 accent circonflexe</b>（形容詞 votre 沒有）' },
  { lesson:27, topic:'pronoms-possessifs', type:'choose', q:'「Ce sont mes chats.」改成所有格代名詞是？', hint:'chat 陽性複數', a:'Ce sont les miens.', aNote:'chat 陽性複數 → <b>les miens</b>。⚠️ 如果是母貓 une chatte，複數就變 les miennes', opts:['Ce sont les miens.','Ce sont les miennes.','C\'est le mien.','Ce sont mes miens.'] },
  { lesson:27, topic:'pronoms-possessifs', type:'choose', q:'notre 跟 le nôtre 差在哪？', hint:'Owen 當堂問的', a:'代名詞 le nôtre 有帽子，而且 o 唸閉口 [o]；形容詞 notre 沒帽子、唸開口 [ɔ]', aNote:'⚠️⚠️ <b>帽子不只是拼寫記號，它就是在標這個 o 唸閉口</b>：notre／votre [ɔ]（像 note）vs nôtre／vôtre [o]（像 nos）。老師課堂說「聽起來一樣」是<b>口語把兩個音中和掉</b>的實際現象，標準法文與考試分得清楚', opts:['代名詞 le nôtre 有帽子，而且 o 唸閉口 [o]；形容詞 notre 沒帽子、唸開口 [ɔ]','兩個拼法不同但發音完全一樣','le nôtre 只能用在複數','notre 是舊寫法'] },
  { lesson:27, topic:'pronoms-possessifs', type:'choose', q:'課文說「c\'est votre tête que l\'employeur veut voir, pas les leurs」——les leurs 指什麼？', hint:'前面那個名詞', a:'家人朋友的臉（leurs têtes）', aNote:'⭐ 複數要整組加 s：<b>les leurs</b>。⚠️ 不能寫成 les leur', opts:['家人朋友的臉（leurs têtes）','老闆的臉','你的照片','公司的員工'] },
  { lesson:27, topic:'pronoms-possessifs', type:'trans', q:'這是我們的，不是你們的。', hint:'兩個都要加帽子', a:"C'est le nôtre, pas le vôtre.", aNote:'⭐ 代名詞版本 <b>nôtre／vôtre 都有 accent circonflexe</b>' },
  { lesson:27, topic:'pronoms-possessifs', type:'trans', q:'他把自己那張（照片）換掉了。', hint:'photo 陰性', a:"Il a changé la sienne.", aNote:'⭐ la sienne＝sa photo。課文原句還加了 <b>pour avoir l\'air plus sérieux</b>（好讓自己看起來更正經）' },

  { lesson:27, topic:'futur-simple', type:'choose', q:'簡單未來式的字尾是從哪裡來的？', hint:'老師說「就是那個 avoir」', a:'avoir 的現在式：ai / as / a / ons / ez / ont', aNote:'⭐ 原形 ＋ avoir 的現在式字尾。這也是歷史真相：拉丁文「原形＋habere（有）」黏成一個字', opts:['avoir 的現在式：ai / as / a / ons / ez / ont','être 的現在式','imparfait 的字尾','都要另外背'] },
  { lesson:27, topic:'futur-simple', type:'fill', q:'Demain, je _____ (prendre) ma voiture.（未來式）', hint:'-re 動詞要去掉 e', a:'prendrai', aNote:'⚠️ prendre → prendr- ＋ ai。<b>-re 結尾的原形要去掉最後那個 e</b>' },
  { lesson:27, topic:'futur-simple', type:'fill', q:"J'_____ (écrire) une lettre demain.（未來式）", hint:'骨架是原形不是現在式', a:'écrirai', aNote:'⚠️⚠️ 老師強調兩次：<b>écrirai 有 r</b>（原形 écrire）。⛔ 不是 écriverai。imparfait 才看 nous écriv-ons → j\'écrivais' },
  { lesson:27, topic:'futur-simple', type:'choose', q:'「Quand nous ...... au salon, tu ...... avec nous ?」（我們去展覽時你會來嗎）', hint:'aller / venir 的字根', a:'irons / viendras', aNote:'⭐⭐ aller→<b>ir-</b>、venir→<b>viendr-</b>。⚠️ 而且 <b>quand ＋ 未來事件時兩邊都用未來式</b>', opts:['irons / viendras','allons / viens','irons / viens','allerons / viendras'] },
  { lesson:27, topic:'futur-simple', type:'fill', q:'Un jour, j\'_____ (avoir) plusieurs robots chez moi.', hint:'avoir 的未來字根', a:'aurai', aNote:'avoir → <b>aur-</b>。⚠️ 跟 j\'ai（現在）差在中間那個 r' },
  { lesson:27, topic:'futur-simple', type:'fill', q:'Ils _____ (faire) toutes les tâches ménagères.', hint:'faire 的未來字根', a:'feront', aNote:'faire → <b>fer-</b> ＋ ils 的 -ont。<b>une tâche ménagère</b>＝家事' },
  { lesson:27, topic:'futur-simple', type:'fill', q:'Dans le futur, il y _____ (avoir) des robots partout, ce _____ (être) comme dans les films.', hint:'兩塊高頻', a:'aura / sera|aura, sera', aNote:'⭐⭐ <b>il y aura</b>（將會有）＋ <b>ce sera</b>（那將會是）——本課最該整塊記住的兩個' },
  { lesson:27, topic:'futur-simple', type:'choose', q:'falloir 跟 pleuvoir 的未來式有什麼特別？', hint:'人稱', a:'只有 il 這一格：il faudra / il pleuvra', aNote:'⭐ 兩個都是<b>無人稱動詞</b>——現在式也只有 il faut / il pleut，沒有 je 的形式', opts:['只有 il 這一格：il faudra / il pleuvra','只有複數形','完全規則','不能用未來式'] },
  { lesson:27, topic:'futur-simple', type:'choose', q:'pouvoir 的未來式字根是？', hint:'雙 r', a:'pourr-（je pourrai）', aNote:'⚠️ 雙 r 的還有 voir → <b>verr-</b>（je verrai）', opts:['pourr-（je pourrai）','pouv-','peuv-','pouvoir-'] },
  { lesson:27, topic:'futur-simple', type:'fill', q:"Peut-être qu'un jour les enfants n'_____ (aller) plus à l'école et _____ (suivre) des cours à distance.", hint:'ne…plus 夾住動詞', a:"iront plus / suivront|iront, suivront", aNote:'⭐ aller→ir-；<b>suivre un cours</b>＝上課。否定 ne…plus 夾住未來式動詞' },
  { lesson:27, topic:'futur-simple', type:'choose', q:'「Je vais manger.」跟「Je mangerai.」差在哪？', hint:'兩種未來', a:'前者是近程／很確定的口語未來，後者是預測、計畫、書面', aNote:'⭐ futur proche（第8課）vs futur simple。講 2050 年這種預測用 <b>futur simple</b>', opts:['前者是近程／很確定的口語未來，後者是預測、計畫、書面','前者是過去','兩個完全一樣','後者只能用在問句'] },
  { lesson:27, topic:'futur-simple', type:'trans', q:'我們的生活在 2050 年會是什麼樣子？', hint:'être 的未來式', a:'Comment seront nos vies en 2050 ?', aNote:'⭐ 課文標題。être → <b>ser-</b> ＋ ils 的 -ont＝seront' },

  { lesson:27, topic:'vocab-innovation', type:'choose', q:'fonctionner 的同義字是？（課本考過）', hint:'口語常用那個', a:'marcher', aNote:'⭐ <b>ça marche</b>＝可以運作／沒問題。⚠️ 不是 aller 也不是 travailler', opts:['marcher','aller','travailler','partir'] },
  { lesson:27, topic:'vocab-innovation', type:'choose', q:'tomber en panne 是什麼意思？', hint:'課本考過', a:'（機器）故障、停止運作', aNote:'⭐ <b>être en panne</b>＝處於故障狀態；<b>tomber en panne</b>＝當場壞掉', opts:['（機器）故障、停止運作','掉到海裡','沒電了要充電','摔壞了外殼'] },
  { lesson:27, topic:'vocab-innovation', type:'choose', q:'découvrir 跟 fabriquer 差在哪？（課本題：機器人要用哪個）', hint:'東西原本存不存在', a:'découvrir 是發現原本就有的，fabriquer 是做出來——機器人要 fabriquer', aNote:'⭐ 名詞版：<b>une découverte</b>（發現）／<b>une invention</b>（發明）', opts:['découvrir 是發現原本就有的，fabriquer 是做出來——機器人要 fabriquer','完全一樣','fabriquer 只能講食物','découvrir 比較正式'] },
  { lesson:27, topic:'vocab-innovation', type:'choose', q:'法文的「人工智慧」縮寫怎麼寫？', hint:'形容詞位置', a:'IA（intelligence artificielle）', aNote:'⚠️⚠️ 法文形容詞放後面，所以是 <b>IA</b> 不是 AI。而且是<b>陰性</b>：l\'IA est révolutionnaire', opts:['IA（intelligence artificielle）','AI','AI française','IAF'] },
  { lesson:27, topic:'vocab-innovation', type:'fill', q:'Cet avion fonctionne avec un _____ électrique.（馬達）', hint:'課本填空', a:'moteur', aNote:'<b>le moteur</b>＝馬達、引擎' },
  { lesson:27, topic:'vocab-innovation', type:'choose', q:'un appareil 只能指電子產品嗎？', hint:'老師特地解釋的', a:'不是，任何幫你做事的器具都算（appareil photo、appareils de musculation）', aNote:'⭐ <b>l\'appareil</b>＝裝置、器具。健身器材也是 appareils', opts:['不是，任何幫你做事的器具都算（appareil photo、appareils de musculation）','只能指電子產品','只能指相機','只能指工業機器'] },
  { lesson:27, topic:'vocab-innovation', type:'trans', q:'這個裝置一點用都沒有，真的很沒用。', hint:'servir à rien', a:"Cet appareil ne sert à rien, il est vraiment inutile.", aNote:'⭐ <b>ne servir à rien</b>＝一點用都沒有；<b>inutile</b> ↔ utile' },
  { lesson:27, topic:'vocab-innovation', type:'choose', q:'la reconnaissance faciale 是什麼？', hint:'reconnaître', a:'臉部辨識', aNote:'⭐ <b>reconnaître</b>＝認出 → la reconnaissance。Face ID 就是這個', opts:['臉部辨識','人臉修圖','視訊會議','表情符號'] },

  { lesson:27, topic:'vocab-reseaux', type:'choose', q:'le public visé 是什麼意思？', hint:'viser', a:'目標對象、你想觸及的那群人', aNote:'⭐ <b>viser</b>＝瞄準（target）。課文：la photo est-elle adaptée au <b>public visé</b> ?', opts:['目標對象、你想觸及的那群人','公開場合','大眾的評價','公共網路'] },
  { lesson:27, topic:'vocab-reseaux', type:'choose', q:'sortir du lot 是什麼意思？', hint:'un lot＝一批', a:'脫穎而出、跟其他人不一樣', aNote:'⭐ <b>un lot</b>＝一批東西 → 從那一批裡走出來＝outstand', opts:['脫穎而出、跟其他人不一樣','退出群組','抽獎中獎','離開網站'] },
  { lesson:27, topic:'vocab-reseaux', type:'choose', q:'il s\'agit de 是什麼意思？', hint:'無人稱句', a:'重點在於…／講的是…', aNote:'⭐ 只有 il 這個形式。課文：<b>il s\'agit d\'attirer la sympathie</b>（重點是要讓人有好感）', opts:['重點在於…／講的是…','他同意…','需要做…','他來自…'] },
  { lesson:27, topic:'vocab-reseaux', type:'trans', q:'要看起來有自信、專業。', hint:'paraître', a:'Il faut paraître sûr de soi et professionnel.', aNote:'⭐ <b>paraître</b>＝顯得；<b>être sûr de soi</b>＝有自信。⚠️ 泛指用 soi，講自己說 sûr de moi' },

  { lesson:27, topic:'vocab-caractere', type:'choose', q:'法文的 maniaque 是什麼意思？', hint:'老師特地更正的假朋友', a:'有潔癖的、對整潔龜毛的', aNote:'⚠️ 不是英文的 maniac（瘋子）。課本寫 <b>maniaque de l\'ordre, de la propreté</b>', opts:['有潔癖的、對整潔龜毛的','發瘋的人','工作狂','很愛社交的'] },
  { lesson:27, topic:'vocab-caractere', type:'choose', q:'peureux 的字根是什麼？', hint:'老師的定義', a:'la peur（恐懼）——quelqu\'un qui a peur facilement', aNote:'⭐ 膽小的。⚠️ 不要跟 <b>paresseux</b>（懶惰）搞混', opts:['la peur（恐懼）——quelqu\'un qui a peur facilement','le père（父親）','peu（少）','la peau（皮膚）'] },
  { lesson:27, topic:'vocab-caractere', type:'choose', q:'「avoir des yeux de lynx」是什麼意思？', hint:'動物比喻', a:'眼力很好，什麼都看得到', aNote:'⭐ 老師的用法：你找半天找不到、別人一眼就看到 → <b>Tu as des yeux de lynx !</b>', opts:['眼力很好，什麼都看得到','眼神很兇','很會記人臉','近視很深'] },
  { lesson:27, topic:'vocab-caractere', type:'choose', q:'「avoir une tête de cochon」在哪裡用？意思是什麼？', hint:'⚠️ 跟我們考的地區有關', a:'魁北克說法，意思是很固執（歐洲說 tête de mule）', aNote:'⚠️⚠️ 加拿大用 <b>tête de cochon</b>、歐洲法語用 <b>(vraie) tête de mule</b>。同義還有 têtu comme une mule / un âne', opts:['魁北克說法，意思是很固執（歐洲說 tête de mule）','法國說法，意思是很笨','比利時說法，意思是很貪吃','瑞士說法，意思是很髒'] },
  { lesson:27, topic:'vocab-caractere', type:'fill', q:'Tatiana ne ment jamais. Elle est toujours _____.（誠實的）', hint:'menteur 的相反', a:'honnête', aNote:'⭐ 動詞 <b>mentir</b>：je mens, tu mens, nous mentons。⚠️ honnête 的 h 不發音' },
  { lesson:27, topic:'vocab-caractere', type:'choose', q:'Antoine ne va pas changer d\'avis parce qu\'il est vraiment ......', hint:'課本填空', a:'têtu', aNote:'⭐ <b>changer d\'avis</b>＝改變主意（不是 changer son avis）。têtu 的字根是 la tête', opts:['têtu','optimiste','discret','prudent'] },

  // ══════════ 第28課：si 條件句完整三式 · si vs quand · le pronom on · 電話與網路詞彙 ══════════
  { lesson:28, topic:'condition-si', type:'choose', q:'si 條件句裡，si 後面那半永遠用什麼時態？', hint:'整課只有這一條主軸', a:'現在式（présent），不管右半邊是什麼', aNote:'⭐⭐ ⛔ 不可以寫 si tu achèteras／si tu voudras。<b>變的只有右半邊</b>', opts:['現在式（présent），不管右半邊是什麼','未來式','跟右半邊一樣的時態','命令式'] },
  { lesson:28, topic:'condition-si', type:'choose', q:'第28課補上的第三式是哪一組？（第25課只學了前兩式）', hint:'第27課剛學完的時態', a:'si ＋ 現在式 ＋ 未來式', aNote:'⭐ 三式：現在＋現在（常態）／現在＋命令（叫人去做）／現在＋<b>未來</b>（預測結果）', opts:['si ＋ 現在式 ＋ 未來式','si ＋ 未來式 ＋ 未來式','si ＋ 現在式 ＋ imparfait','si ＋ 命令式 ＋ 未來式'] },
  { lesson:28, topic:'condition-si', type:'choose', q:'「Si quelqu\'un m\'appelle, je réponds.」用的是哪一式？想表達什麼？', hint:'兩邊都是現在式', a:'第一式，陳述一個常態（每次都這樣）', aNote:'⭐ 課本 Fonctionnement 表第一列。⚠️ 不是在預測未來，是在講習慣', opts:['第一式，陳述一個常態（每次都這樣）','第三式，預測未來','第二式，給建議','假設語氣，講不可能的事'] },
  { lesson:28, topic:'condition-si', type:'fill', q:'Si vous achetez cet ordinateur, vous _____ (pouvoir) installer des logiciels très puissants.', hint:'第三式：右半邊用未來式', a:'pourrez', aNote:'⭐ pouvoir → 未來式字根 <b>pourr-</b>。⛔ 左邊不能寫 si vous achèterez' },
  { lesson:28, topic:'condition-si', type:'fill', q:"Si tu veux écouter de la musique sur ton portable, _____ (télécharger) cette application.", hint:'第二式：右半邊用命令式（tu）', a:'télécharge', aNote:'⭐ -er 動詞的 tu 命令式<b>要去掉 s</b>：tu télécharges → Télécharge !' },
  { lesson:28, topic:'condition-si', type:'choose', q:'si 什麼時候要縮寫成 s\'？', hint:'只有一種情況', a:'只在 il / ils 前面：s\'il, s\'ils', aNote:'⚠️⚠️ <b>si on／si elle／si tu 都不縮寫</b>。課本例句：S\'il se perd dans la rue…', opts:['只在 il / ils 前面：s\'il, s\'ils','所有母音開頭的字前面','elle 前面也要','on 前面也要'] },
  { lesson:28, topic:'condition-si', type:'choose', q:'quand ＋ 未來式 ＋ 未來式 是用來表達什麼？（課本 Remarque）', hint:'課本用的字是 certitude', a:'未來的一件「確定會發生」的事', aNote:'⭐⭐ 課本原話：<b>pour exprimer une certitude dans le futur</b>。Quand tu auras 18 ans…（你一定會滿18歲）', opts:['未來的一件「確定會發生」的事','一個不確定的假設','過去的習慣','一個命令'] },
  { lesson:28, topic:'condition-si', type:'choose', q:'si 跟 quand 中文都能翻成「當…就…」，真正的差別是什麼？', hint:'Owen 當堂問的問題', a:'確定性：quand 的事一定會發生，si 的不一定', aNote:'⭐⭐ <b>中文幫不上忙</b>，要靠這個判準。「你18歲」→ quand；「你贏比賽」→ si', opts:['確定性：quand 的事一定會發生，si 的不一定','si 比較正式','quand 只能用在問句','兩個完全可以互換'] },
  { lesson:28, topic:'condition-si', type:'fill', q:'Quand tu _____ (avoir) 18 ans, je t\'_____ (acheter) un ordinateur.', hint:'quand → 兩邊都未來式', a:'auras / achèterai|auras, achèterai', aNote:'⭐⭐ avoir→<b>aur-</b>；acheter 的未來式全部有 è：j\'<b>achèterai</b>' },
  { lesson:28, topic:'condition-si', type:'fill', q:'Quand nous _____ (savoir) utiliser notre imprimante 3D, nous _____ (fabriquer) plein d\'objets.', hint:'quand → 兩邊都未來式', a:'saurons / fabriquerons|saurons, fabriquerons', aNote:'⭐ savoir→<b>saur-</b>。<b>plein de</b>＝一堆（口語＝beaucoup de）' },
  { lesson:28, topic:'condition-si', type:'choose', q:'「En général, si je dois aller dans un endroit que je ne connais pas, je _____ mon GPS.」要填哪個？', hint:'看句首那兩個字', a:'mets（現在式）——en général 表示這是習慣', aNote:'⚠️⚠️ 有 <b>en général</b> 就是在講已經一直在發生的常態 → 第一式（現在＋現在），不是預測', opts:['mets（現在式）——en général 表示這是習慣','mettrai（未來式）','mettais（imparfait）','mettre（原形）'] },
  { lesson:28, topic:'condition-si', type:'trans', q:'如果我明天迷路，我會跟人問路。', hint:'第三式；se perdre', a:'Si je me perds demain, je demanderai mon chemin à quelqu\'un.', aNote:'⭐⭐ <b>se perdre</b>＝迷路；<b>demander son chemin à qqn</b>＝跟某人問路。主詞是 je → mon chemin' },
  { lesson:28, topic:'condition-si', type:'trans', q:'如果電腦壞了，就打給維修的人。', hint:'第二式；tomber en panne', a:'Si l\'ordinateur tombe en panne, appelle le réparateur.', aNote:'⭐ <b>tomber en panne</b>＝故障；<b>le réparateur</b>＝修理師傅' },
  { lesson:28, topic:'condition-si', type:'choose', q:'「Si vous voulez passer moins de temps sur votre téléphone, lisez un livre !」右半邊是什麼？', hint:'lisez 沒有主詞', a:'命令式（impératif）——第二式，語氣最強', aNote:'⭐ <b>lire</b> 的 vous 命令式是 <b>lisez</b>。命令式沒有主詞，直接把動作丟給對方', opts:['命令式（impératif）——第二式，語氣最強','現在式','未來式','imparfait'] },

  { lesson:28, topic:'on-vs-nous', type:'choose', q:'le pronom on 有哪三種意思？（本課主文法②）', hint:'課本 Fonctionnement 表', a:'quelqu\'un（某人）／les gens（大家）／nous（我們）', aNote:'⭐⭐ 三種意思，但<b>變位永遠跟 il / elle 一樣</b>，這一點不會變', opts:['quelqu\'un（某人）／les gens（大家）／nous（我們）','只有 nous 一種','vous／nous／ils','tu／il／nous'] },
  { lesson:28, topic:'on-vs-nous', type:'choose', q:'「On a volé mon téléphone.」這裡的 on 等於什麼？', hint:'東西是「我的」', a:'quelqu\'un——有人偷了我的手機', aNote:'⭐ 不知道是誰、也不在乎是誰的時候用 on。⚠️ 不可能是「我們」，因為手機是我的', opts:['quelqu\'un——有人偷了我的手機','nous——我們偷了','les gens——大家都偷','vous——你們偷了'] },
  { lesson:28, topic:'on-vs-nous', type:'choose', q:'「Quand on vit sans téléphone, on est plus libre.」這裡的 on 等於什麼？', hint:'⚠️ 這題當堂答錯過', a:'les gens——這是對所有人成立的通則', aNote:'⚠️⚠️ 判準：<b>句子在講普遍現象 → les gens</b>；講「我跟你這幾個人」才是 nous', opts:['les gens——這是對所有人成立的通則','nous——我們兩個','quelqu\'un——某個人','vous——你們'] },
  { lesson:28, topic:'on-vs-nous', type:'choose', q:'「L\'année dernière, on est allés à la RoboCup.」哪個線索告訴你 on ＝ nous？', hint:'看分詞', a:'allés 加了 s——分詞跟著複數配合', aNote:'⭐⭐ on 當「我們」用時，過去分詞可以寫成複數。這是書面上唯一看得出來的線索', opts:['allés 加了 s——分詞跟著複數配合','因為有 l\'année dernière','因為用了 être','因為 RoboCup 是比賽'] },
  { lesson:28, topic:'on-vs-nous', type:'choose', q:'on 要照哪個人稱變位？', hint:'不管它是哪一種意思', a:'永遠照 il / elle', aNote:'⚠️ 所以 ⛔ <b>on visiteras</b> 是錯的，正解 <b>on visitera</b>。這一格不會因為 on＝nous 就改變', opts:['永遠照 il / elle','照 nous','看它代表哪個意思決定','照 ils'] },
  { lesson:28, topic:'on-vs-nous', type:'fill', q:'Quand on _____ (aller) à Paris, on _____ (visiter) le musée des Arts et Métiers.', hint:'quand → 兩邊未來式；on 照 il 變位', a:'ira / visitera|ira, visitera', aNote:'⚠️⚠️ aller→<b>ir-</b>；⛔ 不是 on visiteras——<b>on 永遠沒有 -s</b>' },
  { lesson:28, topic:'on-vs-nous', type:'trans', q:'有人跟你們講過 RoboCup 嗎？', hint:'用 on 開頭的問句', a:'Est-ce qu\'on vous a déjà parlé de la RoboCup ?', aNote:'⭐ 這個 on ＝ quelqu\'un。<b>parler à qqn de qqch</b>' },

  { lesson:28, topic:'vocab-technologies', type:'choose', q:'suivre 是什麼意思？老師用哪句話破題？', hint:'白板上寫的那句', a:'跟隨／照著做／追蹤——Je suis Mbappé sur Instagram', aNote:'⭐⭐ <b>je suis</b> 同時是 être 跟 suivre。只有 je／tu 兩格會撞，il suit ≠ il est', opts:['跟隨／照著做／追蹤——Je suis Mbappé sur Instagram','睡覺','繼續說話','找到'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'un conseil 是什麼？', hint:'課文第一句 Suivez ces conseils', a:'一則建議（advice）', aNote:'⭐ 動詞 <b>conseiller qqch à qqn</b>：je te conseille ce livre', opts:['一則建議（advice）','一場會議','一個委員會','一個諮商師'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'téléphoner 跟 appeler 接人的方式一樣嗎？', hint:'介系詞', a:'不一樣：téléphoner à quelqu\'un（COI）、appeler quelqu\'un（COD）', aNote:'⚠️⚠️ 所以代名詞不同：<b>je lui téléphone</b> vs <b>je l\'appelle</b>。contacter 也是 COD', opts:['不一樣：téléphoner à quelqu\'un（COI）、appeler quelqu\'un（COD）','一樣，都直接接人','一樣，都要加 à','appeler 要加 à'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'décrocher ≠ raccrocher 是哪一組動作？', hint:'字根 crochet＝掛鉤', a:'接起電話 ≠ 掛斷電話', aNote:'⭐ 老式電話掛在鉤子上：dé-＝拿下來、r-＝掛回去。<b>raccrocher au nez</b>＝不客氣地把人電話掛掉', opts:['接起電話 ≠ 掛斷電話','開機 ≠ 關機','登入 ≠ 登出','訂閱 ≠ 退訂'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'手機關機用哪個動詞？門窗關上呢？', hint:'⚠️ 兩組不能混用', a:'手機用 éteindre／allumer；門窗用 fermer／ouvrir', aNote:'⚠️⚠️ <b>allumer / éteindre 只用在電、燈、機器</b>。éteindre 的過去分詞是 <b>éteint</b>', opts:['手機用 éteindre／allumer；門窗用 fermer／ouvrir','都用 fermer／ouvrir','都用 éteindre／allumer','手機用 fermer，門用 éteindre'] },
  { lesson:28, topic:'vocab-technologies', type:'fill', q:'Mon téléphone n\'a plus de _____, il va s\'éteindre.（電池）', hint:'也是「爵士鼓」那個字', a:'batterie', aNote:'⭐ <b>la batterie</b>＝電池，也＝爵士鼓。行動電源是 <b>une batterie portable</b>' },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'être joignable 是什麼意思？', hint:'joindre quelqu\'un', a:'聯絡得上', aNote:'⭐ 老師的例句：<b>Je ne suis pas joignable du 7 au 27 août.</b>（我8/7到8/27聯絡不上）', opts:['聯絡得上','在線上','有空','很好相處'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'「en ligne」是什麼意思？「排隊」又怎麼說？', hint:'⚠️ 英文 in line 的干擾', a:'en ligne＝線上（online）；排隊是 faire la queue', aNote:'⚠️⚠️ <b>la queue</b>＝尾巴——人排成一條尾巴。<b>faire des achats en ligne</b>＝線上購物', opts:['en ligne＝線上（online）；排隊是 faire la queue','en ligne＝排隊；線上是 faire la queue','兩個都是排隊','兩個都是線上'] },
  { lesson:28, topic:'vocab-technologies', type:'fill', q:'les réseaux _____（社群網站，把 social 變成複數）', hint:'-al 結尾的複數', a:'sociaux', aNote:'⚠️⚠️ 兩個字都要變：réseau→réseau<b>x</b>（-eau 加 x）、social→socia<b>ux</b>（-al→-aux，同 cheval→chevaux）' },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'le courriel 是什麼？這個字從哪裡來？', hint:'courrier ＋ 電子', a:'電子郵件＝courrier électronique，魁北克帶起來的字', aNote:'⚠️ 加拿大考試很常見。法國也通用 le mail／l\'e-mail', opts:['電子郵件＝courrier électronique，魁北克帶起來的字','快遞包裹','法院信件','一種通訊軟體'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'suivre 跟 s\'abonner 都能翻成「追蹤」，差在哪？', hint:'動作 vs 狀態', a:'suivre 講動作（我去追蹤），être abonné à 講狀態（我是訂閱者）', aNote:'⭐ <b>un abonnement</b>＝訂閱／會員資格（健身房、電信、電子報都用）。退訂是 <b>se désabonner</b>', opts:['suivre 講動作（我去追蹤），être abonné à 講狀態（我是訂閱者）','完全一樣','suivre 只能用在人','s\'abonner 只能用在報紙'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'「des petites courses」是什麼意思？', hint:'⚠️ 三個很像的字', a:'買點小東西（採買日用品）', aNote:'⚠️⚠️ <b>un cours</b>＝一堂課／<b>une course</b>＝一場賽跑／<b>faire des courses</b>＝買日用品', opts:['買點小東西（採買日用品）','幾堂小課','幾場短跑比賽','幾趟短程車'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'la souris 有兩個意思，是哪兩個？還跟哪個動詞同形？', hint:'老師覺得很妙的那個', a:'老鼠／滑鼠；Souris ! 是 sourire（微笑）的命令式', opts:['老鼠／滑鼠；Souris ! 是 sourire（微笑）的命令式','老鼠／耳機；跟 souhaiter 同形','滑鼠／鍵盤；跟 sourd 同形','老鼠／麵包；跟 sourire 無關'], aNote:'⭐ 法文這種同形字很多，靠句子分' },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'台灣人說的「USB 隨身碟」，法文怎麼說？', hint:'clé', a:'une clé USB', aNote:'⭐ 字面是「USB 鑰匙」。⚠️ 印表機是 <b>l\'imprimante</b>、鍵盤是 <b>le clavier</b>', opts:['une clé USB','un USB','une souris USB','un disque portable'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'le salon 有三個意思，哪一個是課文用的（le salon des innovations）？', hint:'去看展的那個', a:'展覽會（另外兩個是客廳、沙龍/理髮店）', aNote:'⭐ 中文的「沙龍」就是從 <b>un salon de coiffure</b> 來的', opts:['展覽會（另外兩個是客廳、沙龍/理髮店）','客廳','理髮店','起居室的沙發'] },
  { lesson:28, topic:'vocab-technologies', type:'trans', q:'網路很差，我連不上。', hint:'ne pas arriver à', a:'Internet marche mal, je n\'arrive pas à me connecter.', aNote:'⭐⭐ <b>ne pas arriver à ＋ 原形</b>＝做不到（超高頻）；<b>marcher</b>＝運作' },
  { lesson:28, topic:'vocab-technologies', type:'trans', q:'我試著打給他，但他沒接我的電話。', hint:'兩個 COI', a:'J\'ai essayé de lui téléphoner, mais il n\'a pas répondu à mon appel.', aNote:'⭐ <b>téléphoner à</b>→lui；<b>répondre à</b>→à mon appel。⚠️ 名詞 l\'appel 只有一個 l' },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'名詞 l\'appel 一個 l，動詞 j\'appelle 兩個 l——為什麼？', hint:'Owen 當堂問的', a:'字尾 -e 不發音時前面唸開口 [ɛ]，法文用雙寫子音標它', aNote:'⭐⭐ 所以 j\'appe<b>ll</b>e / ils appe<b>ll</b>ent 是兩個 l，但 nous appe<b>l</b>ons / vous appe<b>l</b>ez 只有一個', opts:['字尾 -e 不發音時前面唸開口 [ɛ]，法文用雙寫子音標它','名詞跟動詞的拼法本來就無關','兩個 l 才是舊拼法','沒有規則，要死背'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'太空人的法文，歐洲用哪個字？', hint:'課文 G', a:'un spationaute（美國 astronaute、俄國 cosmonaute）', aNote:'⭐ 三個字指同一種人，看國家換字。課文主角是 <b>Thomas Pesquet</b>', opts:['un spationaute（美國 astronaute、俄國 cosmonaute）','un astronaute，全世界都一樣','un cosmonaute','un aéronaute'] },
  { lesson:28, topic:'vocab-technologies', type:'choose', q:'「J\'espère que la France gagnera.」為什麼用未來式？', hint:'期望的是什麼時候的事', a:'espérer que 後面接的是還沒發生的事 → 用未來式', aNote:'⭐⭐ 課本「exprimer un espoir」框。另一句：<b>On rêve de battre l\'équipe humaine.</b>（rêver de ＋ 原形）', opts:['espérer que 後面接的是還沒發生的事 → 用未來式','espérer 後面固定接未來式，沒有理由','因為 France 是國家','因為是問句'] },

  { lesson:28, topic:'futur-simple', type:'fill', q:'Pour Noël, j\'_____ (offrir) une tablette numérique à mes enfants.（未來式）', hint:'-ir 動詞：整個原形當字根', a:'offrirai', aNote:'⭐ offrir ＋ ai。⚠️ 老師自承這個字他自己有時也要想一下' },
  { lesson:28, topic:'futur-simple', type:'choose', q:'aller 的 va / allez / irez 分別是什麼？老師為什麼拿它當代表？', hint:'三個長得完全不一樣', a:'現在式 il va、現在式 vous allez、未來式 vous irez——同一個動詞三種樣子', aNote:'⚠️⚠️ aller 是最不規則的一個。未來式字根 <b>ir-</b>：j\'irai, nous irons', opts:['現在式 il va、現在式 vous allez、未來式 vous irez——同一個動詞三種樣子','三個都是現在式','三個都是未來式','va 是過去式'] },
  { lesson:28, topic:'futur-simple', type:'fill', q:'Dans le futur, on _____ (fabriquer) des voitures autonomes qui _____ (voler).', hint:'兩邊都未來式；on 照 il 變位', a:'fabriquera / voleront|fabriquera, voleront', aNote:'⭐ on → fabriquera（沒有 s）；les voitures → volero<b>nt</b>。<b>autonome</b>＝自駕的' },

  // ══════════ 第29課：le pronom en（數量完整版）· 義務與禁止 · 食材與量詞 · 食譜動詞 ══════════
  { lesson:29, topic:'pronoms-y-en', type:'choose', q:'老師的一句話口訣：y 跟 en 各取代什麼？', hint:'看介系詞', a:'y 取代 à，en 取代 de', aNote:'⭐⭐ 這一句就把兩個代名詞的分工講完了。J\'y vais（去那裡）／J\'en reviens（從那裡回來）', opts:['y 取代 à，en 取代 de','y 取代 de，en 取代 à','兩個都取代 de','兩個都取代地點'] },
  { lesson:29, topic:'pronoms-y-en', type:'choose', q:'「Tu as une grande poêle ?」用 en 回答「有，我有一個」怎麼說？', hint:'數字要不要留', a:'Oui, j\'en ai une.', aNote:'⚠️⚠️ <b>une 要留下來</b>——這裡的 une 是「一個」不是冠詞。en 只收掉 poêle', opts:['Oui, j\'en ai une.','Oui, j\'en ai.','Oui, je l\'ai une.','Oui, j\'ai une.'] },
  { lesson:29, topic:'pronoms-y-en', type:'fill', q:'Vous consommez beaucoup de fruits ? — Oui, j\'_____ consomme _____.（用 en 回答「很多」）', hint:'數量副詞要留下來', a:'en / beaucoup|en, beaucoup', aNote:'⭐ 不精確數量：<b>beaucoup 要留在動詞後面</b>' },
  { lesson:29, topic:'pronoms-y-en', type:'choose', q:'passé composé 裡的 en 要放在哪裡？', hint:'第21課同一條規則', a:'放在助動詞前面：J\'en ai mangé', aNote:'⚠️⚠️ ⛔ 不是分詞前面。否定是 <b>Je n\'en ai pas mangé</b>（n\' ＋ en ＋ 助動詞 ＋ pas ＋ 分詞）', opts:['放在助動詞前面：J\'en ai mangé','放在過去分詞前面：J\'ai en mangé','放在句尾','放在主詞前面'] },
  { lesson:29, topic:'pronoms-y-en', type:'fill', q:'Je ne consomme pas beaucoup de légumes.（改成用 en）', hint:'beaucoup 留著', a:'Je n\'en consomme pas beaucoup.', aNote:'⭐ 課本第3題。en 夾在 ne 跟動詞之間' },
  { lesson:29, topic:'pronoms-y-en', type:'fill', q:'Ils n\'ont pas bu deux litres de café.（改成用 en）', hint:'數字留著、en 在助動詞前', a:'Ils n\'en ont pas bu deux litres.', aNote:'⚠️ <b>deux litres 要留下來</b>；en 貼在 ont 前面' },
  { lesson:29, topic:'pronoms-y-en', type:'choose', q:'「Elle ne conseille pas d\'acheter du saumon.」用 en 改寫，正確的是？', hint:'那個 de 是誰的', a:'Elle ne conseille pas d\'en acheter.', aNote:'⚠️⚠️ 陷阱題：<b>de 是 conseiller de 的</b>，不是 saumon 的。en 收掉 du saumon，貼在 acheter 前面', opts:['Elle ne conseille pas d\'en acheter.','Elle n\'en conseille pas d\'acheter.','Elle ne conseille pas d\'acheter en.','Elle n\'en conseille pas acheter.'] },
  { lesson:29, topic:'pronoms-y-en', type:'choose', q:'什麼時候用 en、什麼時候用 le / la？（老師的判準）', hint:'水 vs 電腦', a:'不特定的「量」用 en，特定的那一個東西用 le / la', aNote:'⭐⭐ <b>De l\'eau ? j\'en veux</b>（水有很多）／<b>L\'ordinateur ? je le veux</b>（只有那一台）', opts:['不特定的「量」用 en，特定的那一個東西用 le / la','en 用在食物，le 用在人','en 比較正式','兩個可以互換'] },
  { lesson:29, topic:'pronoms-y-en', type:'choose', q:'別人問「Tu veux de l\'eau ?」，為什麼不能只回答「Oui, je veux.」？', hint:'vouloir 後面', a:'vouloir 後面一定要有東西——要說 Oui, j\'en veux.', aNote:'⭐ 法文的 vouloir 不能空著。⚠️ 如果是特定那杯就說 <b>je la veux</b>', opts:['vouloir 後面一定要有東西——要說 Oui, j\'en veux.','因為 je veux 太不禮貌','因為要用 je voudrais','因為水是不可數的'] },
  { lesson:29, topic:'pronoms-y-en', type:'trans', q:'披薩可以放鳳梨嗎？——可以放。', hint:'動詞是 mettre', a:'Est-ce qu\'on peut mettre de l\'ananas dans une pizza ? — Oui, on peut en mettre.', aNote:'⭐ en 貼在原形 <b>mettre</b> 前面（不是 peut 前面）' },
  { lesson:29, topic:'pronoms-y-en', type:'choose', q:'口語裡「我沒有」常常聽到哪一種說法？（課本 Attention）', hint:'ne 會消失', a:'J\'en ai pas.（ne 被吃掉）', aNote:'⚠️ 標準寫法是 <b>Je n\'en ai pas.</b>。⭐ 老師強調：<b>ne 才是真正的否定</b>（pas 可換成 rien／personne／jamais），但講話時反而是 ne 不見', opts:['J\'en ai pas.（ne 被吃掉）','Je n\'ai pas en.','J\'ai pas en.','Je en ai pas.'] },

  { lesson:29, topic:'interdiction-demande', type:'choose', q:'il faut 跟 il est interdit 後面接原形時，哪個要加 de？', hint:'課本 Fonctionnement 表', a:'il faut 直接接原形；il est interdit 要加 de', aNote:'⭐⭐ 一整排都要 de：il est nécessaire <b>de</b>、il est indispensable <b>de</b>、il est défendu <b>de</b>、vous avez l\'obligation <b>de</b>。只有 <b>il faut</b> 跟 <b>vous devez</b> 不用', opts:['il faut 直接接原形；il est interdit 要加 de','兩個都要加 de','兩個都不用加','il faut 要加 de；il est interdit 不用'] },
  { lesson:29, topic:'interdiction-demande', type:'choose', q:'表達「義務」的四個說法是？（課本表左欄）', hint:'成對記', a:'il faut／il est nécessaire de／il est indispensable de／vous avez l\'obligation de', aNote:'⭐ 對應的禁止是：il ne faut pas／il est interdit de／il est défendu de／vous ne devez pas', opts:['il faut／il est nécessaire de／il est indispensable de／vous avez l\'obligation de','il faut／il est possible de／il est facile de／vous pouvez','il y a／il est／il fait／vous êtes','il vaut mieux／il paraît／il semble／vous voulez'] },
  { lesson:29, topic:'interdiction-demande', type:'fill', q:'Se laver les mains → _____ les mains !（命令式 vous）', hint:'代名詞要跑到後面', a:'Lavez-vous', aNote:'⚠️⚠️ 反身動詞的<b>肯定</b>命令式，代名詞放動詞後面並用連字號：<b>Lavez-vous les mains !</b>' },
  { lesson:29, topic:'interdiction-demande', type:'choose', q:'對 tu 說「刷你的牙」，反身代名詞要用哪個？', hint:'te 會變', a:'toi：Brosse-toi les dents.', aNote:'⚠️⚠️ 肯定命令式後面用<b>重讀代名詞</b>：moi／toi／lui／nous／vous／leur。⛔ 不是 brosse-te', opts:['toi：Brosse-toi les dents.','te：Brosse-te les dents.','tu：Brosse-tu les dents.','se：Brosse-se les dents.'] },
  { lesson:29, topic:'interdiction-demande', type:'choose', q:'否定命令式的反身代名詞放哪裡？', hint:'跟肯定相反', a:'放回動詞前面：Ne vous lavez pas les mains ici.', aNote:'⚠️ <b>只有肯定命令式會後移</b>，否定的又回到動詞前面', opts:['放回動詞前面：Ne vous lavez pas les mains ici.','一樣放後面','兩種都可以','否定命令式不能用反身動詞'] },
  { lesson:29, topic:'interdiction-demande', type:'trans', q:'在台灣的捷運裡，禁止飲食。', hint:'兩個動詞各自帶 de', a:'Dans le métro taïwanais, il est interdit de manger et de boire.', aNote:'⚠️⚠️ <b>de manger et de boire</b>——兩個原形都要各自帶 de' },
  { lesson:29, topic:'interdiction-demande', type:'trans', q:'在這家餐廳，必須事先訂位。', hint:'il faut', a:'Dans ce restaurant, il faut réserver la table à l\'avance.', aNote:'⭐ <b>il faut ＋ 原形</b>（⛔ 不加 de）；<b>à l\'avance</b>＝事先' },
  { lesson:29, topic:'interdiction-demande', type:'choose', q:'interdit 跟 défendu 的語感差在哪？（老師的說法）', hint:'後果不同', a:'interdit 比較硬（真的違規），défendu 比較軟（勸阻、對你不好）', aNote:'⭐ 老師的例子：<b>il est défendu de boire l\'eau de ce robinet</b>——喝了會生病，但不會有人來抓你', opts:['interdit 比較硬（真的違規），défendu 比較軟（勸阻、對你不好）','完全一樣','défendu 只用在軍事','interdit 是口語，défendu 是書面'] },
  { lesson:29, topic:'interdiction-demande', type:'fill', q:'Sinon, vous pouvez prendre une _____.（罰款）', hint:'跟「杏仁」同音', a:'amende', aNote:'⚠️⚠️ <b>une amende</b>＝罰款、<b>une amande</b>＝杏仁，兩個同音。<b>une amende salée</b>＝重罰' },

  { lesson:29, topic:'vocab-aliments', type:'choose', q:'法文的 le raisin 是什麼？葡萄乾又怎麼說？', hint:'⚠️ 英法假朋友', a:'le raisin＝葡萄；葡萄乾是 les raisins secs', aNote:'⚠️⚠️ 英文 raisin 才是葡萄乾。法文要加 <b>sec</b> 才變乾的', opts:['le raisin＝葡萄；葡萄乾是 les raisins secs','le raisin＝葡萄乾；葡萄是 la grappe','兩個都是葡萄乾','兩個都是葡萄'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'la mûre 跟 la myrtille 分別是什麼？', hint:'兩種莓果', a:'mûre＝黑莓、myrtille＝藍莓', aNote:'⚠️ 還有 <b>mûr</b>（不加 e）是形容詞「成熟的」——三個一起記', opts:['mûre＝黑莓、myrtille＝藍莓','mûre＝藍莓、myrtille＝黑莓','兩個都是覆盆子','mûre＝桑葚、myrtille＝草莓'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'「我把蛋糕烤熟」跟「我被曬到爆」在法文差一個字，是哪個字？', hint:'老師的笑點', a:'faire：je fais cuire le gâteau vs je cuis au soleil', aNote:'⚠️⚠️ 煮東西一定要 <b>faire cuire</b>；少了 faire，被煮的就是你自己', opts:['faire：je fais cuire le gâteau vs je cuis au soleil','avoir','être','aller'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'mettre au four 還有一個單字說法，是哪個？', hint:'把 four 變動詞', a:'enfourner', aNote:'⭐ <b>en- ＋ four</b>。相對地拿出來是 <b>sortir du four</b>', opts:['enfourner','fourrer','chauffer','fournir'] },
  { lesson:29, topic:'vocab-aliments', type:'fill', q:'Préchauffez le _____ à 200°C.（烤箱）', hint:'食譜第一步', a:'four', aNote:'⭐ <b>préchauffer</b>＝pré（預先）＋ chauffer（加熱）' },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'一撮鹽、一束薄荷、一球冰淇淋，量詞分別是？', hint:'課本 Les quantités', a:'une pincée de sel／un bouquet de menthe／une boule de glace', aNote:'⭐ 其他：<b>une barquette de</b> framboises（小盒）、<b>une botte d\'</b>oignons（一把）、<b>une tablette de</b> chocolat（一片）', opts:['une pincée de sel／un bouquet de menthe／une boule de glace','une botte de sel／une barquette de menthe／une tablette de glace','une boule de sel／une pincée de menthe／un bouquet de glace','une tablette de sel／une boule de menthe／une botte de glace'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'洋蔥、胡蘿蔔、小蘿蔔這種「綁成一把」的量詞是？', hint:'課本例句 Une botte de carottes', a:'une botte de', aNote:'⭐ 課本第3題的示範就是 <b>une botte de carottes</b>', opts:['une botte de','une barquette de','une boule de','une pincée de'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'le poireau 是什麼？', hint:'台灣沒有', a:'韭蔥（長得像超長超粗的蔥）', aNote:'⚠️ 課文那一串台灣少見的：poireau（韭蔥）、betterave（甜菜根）、endive（苦苣）、navet（蕪菁）', opts:['韭蔥（長得像超長超粗的蔥）','青椒','豌豆','菠菜'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'la courge 跟 la courgette 的關係是？', hint:'字尾 -ette', a:'courge 是瓜科總稱，courgette（櫛瓜）是其中一種', aNote:'⭐ 字尾 <b>-ette</b>＝小的。老師：courge 是一整個家族', opts:['courge 是瓜科總稱，courgette（櫛瓜）是其中一種','完全一樣','courgette 是大的，courge 是小的','courge 是水果，courgette 是蔬菜'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'les légumes secs 指的是什麼？', hint:'課文提到 lentilles', a:'乾豆類（扁豆、鷹嘴豆那一類）', aNote:'⚠️ 不是「乾掉的蔬菜」。<b>les céréales</b>＝穀類（米、麵粉、粗麥）是另一組', opts:['乾豆類（扁豆、鷹嘴豆那一類）','曬乾的蔬菜','沒有水分的沙拉','冷凍蔬菜'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'un poulailler 是什麼？', hint:'從 poulet 想', a:'雞舍', aNote:'⭐ <b>le poulet</b>（雞）＋ 表示地點的字尾。課文：les œufs de mon poulailler', opts:['雞舍','雞肉料理','養雞的人','雞蛋盒'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'la crème liquide 跟 la crème fraîche 差在哪？', hint:'老師拿實物比', a:'liquide 是稀的可以倒，fraîche 是稠的', aNote:'⭐ 食譜的 clafoutis 用的是 <b>crème liquide</b>；<b>la crème chantilly</b> 則是打發的鮮奶油', opts:['liquide 是稀的可以倒，fraîche 是稠的','liquide 是熱的，fraîche 是冷的','完全一樣','liquide 有加糖，fraîche 沒有'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'食譜寫 20 cl de lait，換成台灣的單位是多少？', hint:'加一個 0', a:'200 ml', aNote:'⚠️ 法國用 <b>cl</b>（centilitre）。<b>cl 後面加一個 0 就是 ml</b>', opts:['200 ml','20 ml','2000 ml','2 ml'] },
  { lesson:29, topic:'vocab-aliments', type:'trans', q:'把麵糊倒在水果上。', hint:'verser / la pâte', a:'Versez la pâte sur les fruits.', aNote:'⭐ <b>la pâte</b>＝混好還沒烤的狀態（pâte à crêpes／pâte à pain 都是它）' },
  { lesson:29, topic:'vocab-aliments', type:'trans', q:'表面金黃的時候把蛋糕拿出烤箱，讓它放涼。', hint:'doré / sortir du four / laisser refroidir', a:'Sortez le gâteau du four quand le dessus est doré et laissez refroidir.', aNote:'⭐ <b>doré</b>＝金黃（來自 or＝金）；<b>laisser refroidir</b>＝讓它冷卻' },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'tiède 是什麼溫度？', hint:'三段中間那個', a:'溫的（froid → tiède → chaud）', aNote:'⭐ 食譜最後一句：<b>Servez tiède</b>＝溫溫的上桌', opts:['溫的（froid → tiède → chaud）','冰的','滾燙的','常溫但偏冷'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'propre 放在名詞前面跟後面，意思差在哪？（第22課回鍋）', hint:'課文的 ses propres légumes', a:'前面＝自己的；後面＝乾淨的', aNote:'⭐ <b>mon propre mug</b>（我自己的杯子）vs <b>mon mug est propre</b>（我的杯子很乾淨）', opts:['前面＝自己的；後面＝乾淨的','前面＝乾淨的；後面＝自己的','兩個一樣','只能放後面'] },
  { lesson:29, topic:'vocab-aliments', type:'choose', q:'「C\'est la spécialité de la maison.」是什麼意思？', hint:'課本 Unité 6 標語', a:'這是本店的招牌菜', aNote:'⭐ 老師的延伸：去外婆家永遠想吃同一道，因為那是 <b>sa spécialité</b>', opts:['這是本店的招牌菜','這是這間房子的特色','這是家常菜','這是今日特價'] },

  { lesson:30, topic:'restriction-ne-que', type:'choose', q:'ne...que 表達什麼意思？可以換成哪三個字？', hint:'課本 Fonctionnement', a:'限制（只），可換成 uniquement／juste／seulement', aNote:'⭐⭐ <b>ne/n\' 放動詞前面，que/qu\' 放動詞後面</b>：Je ne mets que 4 étoiles sur 5.', opts:['限制（只），可換成 uniquement／juste／seulement','否定，可換成 pas du tout','加強語氣，可換成 vraiment','比較，可換成 plus que'] },
  { lesson:30, topic:'restriction-ne-que', type:'fill', q:'Ce restaurant propose uniquement des plats à base de riz.（改成 ne...que）', hint:'ne 前 que 後', a:'Ce restaurant ne propose que des plats à base de riz.', aNote:'課本範例句' },
  { lesson:30, topic:'restriction-ne-que', type:'fill', q:'Je suis juste allergique aux œufs.（改成 ne...que，注意母音）', hint:'allergique 開頭是母音', a:'Je ne suis qu\'allergique aux œufs.', aNote:'⚠️ 母音開頭要用 <b>qu\'</b>' },
  { lesson:30, topic:'restriction-ne-que', type:'trans', q:'她只吃自己菜園種的菜。', hint:'le potager', a:'Elle ne mange que les légumes de son potager.', aNote:'⭐ 呼應第29課課文A自己種菜的女性；<b>le potager</b>＝菜園' },
  { lesson:30, topic:'restriction-ne-que', type:'choose', q:'「Elle n\'achète pas que des produits sains.」是什麼意思？', hint:'⚠️ 多了 pas', a:'她買的不只是健康食品', aNote:'⚠️⚠️ <b>pas que</b>＝不只（＝pas seulement），跟單純 ne...que（只）意思相反', opts:['她買的不只是健康食品','她完全不買健康食品','她只買健康食品','她從不買東西'] },
  { lesson:30, topic:'restriction-ne-que', type:'choose', q:'「Il ne mange plus que du poulet.」是什麼意思？', hint:'plus 跟 que 疊用', a:'他現在只吃雞肉了（以前什麼肉都吃）', aNote:'⭐⭐ <b>ne...plus que</b>＝現在只剩下…（plus＝不再＋que＝限制）', opts:['他現在只吃雞肉了（以前什麼肉都吃）','他不再吃雞肉了','他從來沒吃過雞肉','他吃得比雞肉還多'] },
  { lesson:30, topic:'restriction-ne-que', type:'trans', q:'我只吃當季水果。', hint:'consommer / de saison', a:'Je ne consomme que des fruits de saison.', aNote:'課本 Entraînement 第3a題答案' },
  { lesson:30, topic:'restriction-ne-que', type:'trans', q:'這位主廚只得到好評。', hint:'passé composé', a:'Ce chef n\'a eu que de bonnes critiques.', aNote:'⭐ 課本第3b題答案。<b>une critique</b> 在法文可正可負，不像英文 criticism 偏負面' },
  ...
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'fade 的反義字是哪個？（不是 salé）', hint:'老師的判準：加鹽會怎樣', a:'goûteux', aNote:'⭐ 老師：加鹽 (sel) 會讓食物從 fade（淡而無味）變 goûteux（有味道），不是直接變 salé', opts:['goûteux','amer','acide','gras'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'gras 跟 gros 差在哪？', hint:'食物 vs 人／物', a:'gras 形容食物油（含脂），gros 形容人或物胖、大', aNote:'⚠️⚠️ 兩個字容易混，發音也不同', opts:['gras 形容食物油（含脂），gros 形容人或物胖、大','完全一樣，可以互換','gras 形容人，gros 形容食物','gras 是陽性，gros 是陰性'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'déguster 跟 goûter 差在哪？', hint:'享受感', a:'déguster 是帶著享受、專注品嚐；goûter 只是單純試味道', aNote:'⭐⭐ 課本定義：déguster＝manger ou boire de petites quantités（帶著享受地小口吃）', opts:['déguster 是帶著享受、專注品嚐；goûter 只是單純試味道','兩個一樣','déguster 是喝，goûter 是吃','goûter 只用在早餐'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'grignoter 是什麼意思？', hint:'課文F 註解', a:'正餐之間吃一點（manger un peu entre les repas）', aNote:'⭐ 課文F 註1 原文定義', opts:['正餐之間吃一點（manger un peu entre les repas）','吃得很快','吃得很飽','邊走邊吃'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'gourmand 跟 gourmet 差在哪？', hint:'課本第4題定義配對', a:'gourmand＝愛吃、吃很多；gourmet＝懂吃、講究精緻料理', aNote:'⭐⭐ 課本定義：gourmand＝aime manger；gourmet＝aime surtout les plats très fins, la grande cuisine', opts:['gourmand＝愛吃、吃很多；gourmet＝懂吃、講究精緻料理','兩個意思一樣','gourmand 是男性，gourmet 是女性','gourmet 指吃很多的人'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'une personne végan(e) 的課本定義是？', hint:'跟 végétarien 不同', a:'ne mange pas de produits d\'origine animale（不吃任何動物性來源的食物）', aNote:'⚠️ 比 végétarien 更嚴格：奶、蛋、起司全部不吃', opts:['ne mange pas de produits d\'origine animale（不吃任何動物性來源的食物）','ne mange pas de légumes','ne mange que de la viande','ne mange pas de fruits'] },
  { lesson:30, topic:'vocab-restauration', type:'fill', q:'肉的四種熟度，由生到熟排序：_____ / saignant(e) / à point / bien cuit(e)', hint:'比 saignant 還生', a:'bleu', aNote:'⭐ 老師補充：台灣習慣問三分五分七分熟，法式只分四級，bleu 比三分還生' },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'le pot-au-feu 是什麼？（老師特別澄清的一題）', hint:'⚠️ 不是台灣的那個', a:'蔬菜燉牛肉湯，撈出來放到盤子上吃', aNote:'⚠️⚠️ 老師特別澄清：<b>不是火鍋</b>！湯裡有肉有菜，但吃法是撈出來放盤子上吃，不是邊煮邊涮', opts:['蔬菜燉牛肉湯，撈出來放到盤子上吃','法式火鍋，邊煮邊涮著吃','清蒸魚湯','馬鈴薯濃湯'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'la choucroute 這道菜跟哪個地區有關？為什麼？', hint:'鄰近德國', a:'阿爾薩斯（Alsace），因為緊鄰德國、二戰期間曾受德國影響', aNote:'🇫🇷 老師補充的地方文化', opts:['阿爾薩斯（Alsace），因為緊鄰德國、二戰期間曾受德國影響','布列塔尼，因為靠海','普羅旺斯，因為氣候溫暖','諾曼第，因為產蘋果'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'gastronomique 這個字怎麼拆解？', hint:'胃＋知識', a:'gastro-（胃、腹部）＋ -nomique（知識、規律）＝「胃的知識」', aNote:'⭐⭐ 跟英文 gastric 同源；-nomique 跟 économique 的 -nomique 同一組字根', opts:['gastro-（胃、腹部）＋ -nomique（知識、規律）＝「胃的知識」','gastro-（客人）＋ -nomique（餐廳）','完全沒有字根關係','gastro-（味道）＋ -nomique（顏色）'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'Ça vous a plu? 評論裡「un coup de cœur」是什麼意思？', hint:'課本註解', a:'一見鍾情（對物、地方、作品的立即好感）', aNote:'⭐ 課本註1：Amour immédiat pour une chose, un lieu, une œuvre d\'art…', opts:['一見鍾情（對物、地方、作品的立即好感）','曬傷','心碎','很生氣'] },
  { lesson:30, topic:'vocab-restauration', type:'choose', q:'表達對餐廳不滿意，課本給的句型不包括哪一個？', hint:'找出不屬於這組的', a:'C\'est un régal !', aNote:'⚠️ 這句是<b>滿意</b>用語。不滿意句型：Le service est trop lent／C\'est une honte！／C\'est scandaleux de payer aussi cher！', opts:['C\'est un régal !','Le service est trop lent.','C\'est une honte !','C\'est scandaleux de payer aussi cher !'] },

  { lesson:31, topic:'pronoms-cod-coi', type:'choose', q:'「Tu as acheté l\'oreiller parfait ? — Oui, je l\'ai acheté.」的 l\' 是哪一種代名詞？', hint:'有沒有接 à', a:'COD（直接受詞，不接à）', aNote:'⭐⭐ l\'oreiller parfait 不接 à，直接是 acheter 的受詞', opts:['COD（直接受詞，不接à）','COI（間接受詞，接à）','重讀代名詞','所有格'] },
  { lesson:31, topic:'pronoms-cod-coi', type:'choose', q:'「Tu donnes des conseils à Hamid ? — Oui, je lui conseille de dormir sur le côté.」的 lui 是哪一種代名詞？', hint:'à Hamid', a:'COI（間接受詞，接à）', aNote:'⭐⭐ à Hamid 用 à 接，conseiller 本身要求 à quelqu\'un', opts:['COI（間接受詞，接à）','COD（直接受詞）','重讀代名詞','關係代名詞'] },
  { lesson:31, topic:'pronoms-cod-coi', type:'fill', q:'Raoul lit une histoire à ses filles tous les soirs.（改用代名詞）', hint:'à ses filles → ?', a:'Raoul leur lit une histoire tous les soirs.', aNote:'課本範例句，COI複數' },
  { lesson:31, topic:'pronoms-cod-coi', type:'fill', q:'J\'aime beaucoup faire la sieste.（改用代名詞，注意位置）', hint:'la sieste 是哪個動詞的受詞？', a:'J\'aime beaucoup la faire.', aNote:'⚠️⚠️ la 貼著 faire（真正支配它的動詞），不是 aime' },
  { lesson:31, topic:'pronoms-cod-coi', type:'choose', q:'兩個動詞連用時，COD/COI 代名詞應該放在哪裡？', hint:'見上一題', a:'放在真正支配它的那個動詞前面（不一定是句子第一個動詞）', aNote:'⚠️⚠️ 例：J\'aime beaucoup la faire——la 貼 faire 不是 aime', opts:['放在真正支配它的那個動詞前面（不一定是句子第一個動詞）','永遠放在句子最前面的動詞前','永遠放在句尾','看說話者習慣，沒有固定規則'] },
  { lesson:31, topic:'pronoms-cod-coi', type:'trans', q:'她晚上從不打電話給她父母。（改用代名詞）', hint:'à ses parents → COI複數', a:'Béatrice ne leur téléphone jamais le soir.', aNote:'⚠️ leur（COI複數）不加s，別跟所有格leurs搞混' },
  { lesson:31, topic:'pronoms-cod-coi', type:'choose', q:'COD 跟 COI 同一句疊用時，順序是？', hint:'le lui vs lui le', a:'COD（le/la/les）在前，COI（lui/leur）在後', aNote:'⭐⭐⭐ 例：Tu as acheté l\'oreiller à Marc ? — Je le lui ai acheté.', opts:['COD（le/la/les）在前，COI（lui/leur）在後','COI在前，COD在後','看動詞決定，沒有固定順序','兩個代名詞不能同時出現'] },
  { lesson:31, topic:'pronoms-cod-coi', type:'trans', q:'你買了完美的枕頭給 Marc 嗎？——對，我買給他了。（COD+COI疊用）', hint:'le lui', a:'Tu as acheté l\'oreiller parfait à Marc ? — Oui, je le lui ai acheté.', aNote:'⭐⭐⭐ le＝l\'oreiller（COD），lui＝à Marc（COI）' },
  { lesson:31, topic:'pronoms-cod-coi', type:'choose', q:'哪些動詞固定要接「(quelque chose) à quelqu\'un」，一定搭配 COI？', hint:'課本整理清單', a:'apporter・conseiller・demander・donner・écrire・expliquer・lire・offrir・prêter/emprunter・répondre', aNote:'⭐⭐ 這些動詞看到人就直接換成 COI（lui/leur/me/te...）', opts:['apporter・conseiller・demander・donner・écrire・expliquer・lire・offrir・prêter/emprunter・répondre','aimer・regarder・écouter・attendre','manger・boire・dormir・parler','être・avoir・faire・aller'] },
  { lesson:31, topic:'pronoms-cod-coi', type:'choose', q:'donner 跟 offrir 的關鍵差別是？', hint:'東西會不會被要回去', a:'donner比較廣義（可能被要回去）；offrir是真正的禮物（對方會留著）', aNote:'⭐⭐ 老師的區分方式', opts:['donner比較廣義（可能被要回去）；offrir是真正的禮物（對方會留著）','兩個意思完全一樣','donner 用於物品，offrir 用於金錢','offrir 比較不禮貌'] },

  { lesson:31, topic:'corps-sante-vocab', type:'choose', q:'néo-végétarien 跟 végétarien 的關係是？', hint:'傘概念 vs 子概念', a:'néo-végétarien 是更大的傘概念，包含 flexitarien 在內；végétarien 是完全不吃肉的正式定義', aNote:'⭐⭐ 老師當堂澄清的概念層級', opts:['néo-végétarien 是更大的傘概念，包含 flexitarien 在內；végétarien 是完全不吃肉的正式定義','兩個完全一樣','néo-végétarien 比 végétarien 吃更少','végétarien 包含 néo-végétarien'] },
  { lesson:31, topic:'corps-sante-vocab', type:'choose', q:'flexitarien 是什麼意思？', hint:'圖表註腳原句', a:'還是吃肉，但盡量少吃（ne mange que très peu de viande et de poisson）', aNote:'⭐⭐ 跟完全不吃肉的végétarien是不同層級', opts:['還是吃肉，但盡量少吃（ne mange que très peu de viande et de poisson）','完全不吃肉','只吃素還吃蛋奶','只在特定節日吃素'] },
  { lesson:31, topic:'corps-sante-vocab', type:'choose', q:'「Il est conseillé de ne pas manger lourd au dîner.」這句的否定詞放在哪裡？', hint:'兩個動詞疊用', a:'放在第二個原形動詞（manger）前面，不是放在第一個動詞', aNote:'⚠️⚠️ il est conseillé de + ne pas + manger，否定包住原形動詞', opts:['放在第二個原形動詞（manger）前面，不是放在第一個動詞','放在 il est 前面','放在句尾','兩個地方都要放'] },
  { lesson:31, topic:'corps-sante-vocab', type:'choose', q:'colonne vertébrale 是什麼？', hint:'課文A', a:'脊椎', aNote:'課文A「Pour bien dormir」核心詞', opts:['脊椎','肩膀','脖子','大腿'] },
  { lesson:31, topic:'corps-sante-vocab', type:'fill', q:'睡眠週期第四階段「Sommeil très profond」時長多久？是哪個關鍵功能的階段？', hint:'恢復', a:'30分鐘，étape cruciale de récupération（身體恢復的關鍵階段）', aNote:'課文C 睡眠週期表' },
  { lesson:31, topic:'corps-sante-vocab', type:'choose', q:'睡眠五階段中，哪一階段會做夢？', hint:'快速動眼期', a:'Sommeil paradoxal（快速動眼期）', aNote:'⭐⭐ déclenchement des rêves（觸發做夢）發生在這個階段', opts:['Sommeil paradoxal（快速動眼期）','Endormissement（入睡）','Sommeil profond（深睡）','Sommeil lent léger（淺睡）'] },
  { lesson:31, topic:'corps-sante-vocab', type:'choose', q:'「Redescendre sur terre」是什麼意思？', hint:'課文B 慣用語', a:'回到現實（revenir à la réalité）', aNote:'⭐⭐ 課本第6題慣用語，字面「重新降落到地面」', opts:['回到現實（revenir à la réalité）','起飛、離開地面','跌倒受傷','進入深睡'] },
  { lesson:31, topic:'corps-sante-vocab', type:'trans', q:'我想你。（manquer 句型，⚠️ 主受詞方向）', hint:'不是 Je te manque', a:'Tu me manques.', aNote:'⚠️⚠️⚠️ manquer 的邏輯主詞是被想念的人，跟英文 I miss you 主受詞方向相反' },
  { lesson:31, topic:'corps-sante-vocab', type:'choose', q:'「J\'ai manqué le film.」是什麼意思？', hint:'跟 manquer de 不同', a:'我錯過了這部電影', aNote:'⭐ manquer + 名詞（無de）＝錯過；manquer de + 名詞＝缺乏', opts:['我錯過了這部電影','我很想念這部電影','我沒看過這部電影的簡介','我缺乏電影的資訊'] },
  { lesson:31, topic:'corps-sante-vocab', type:'choose', q:'mal à la tête 跟 les maux de tête 差在哪？', hint:'老師的區分', a:'mal à la tête 是一般頭痛；les maux de tête 語感更接近長期反覆發作的頭痛（比較像migraine）', aNote:'⚠️⚠️ maux 是 mal 的不規則複數', opts:['mal à la tête 是一般頭痛；les maux de tête 語感更接近長期反覆發作的頭痛（比較像migraine）','兩個完全一樣','mal à la tête 比較嚴重','les maux de tête 只用在小孩身上'] },
