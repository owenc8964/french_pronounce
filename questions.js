...
const BANK = [
  ...
  { lesson:33, topic:'cause-consequence', type:'fill', q:"Je (ne) peux pas regarder le journal télé, _____ des images qui sont souvent horribles.", hint:'負面原因＋名詞', a:'à cause', aNote:'à cause de ＋ 名詞，帶出不好的原因；des＝de ＋ les（課本暖身a）' },
  { lesson:33, topic:'cause-consequence', type:'fill', q:"_____ Twitch, les médias classiques essaient de toucher un public plus jeune et plus connecté.", hint:'正面原因＋名詞', a:'Grâce à', aNote:'grâce à ＝ thanks to，帶出好的原因（課本暖身b）' },
  { lesson:33, topic:'cause-consequence', type:'fill', q:"Je suis toujours informée _____ réseaux sociaux.", hint:'grâce à ＋ les', a:'grâce aux', aNote:'⚠️ à ＋ les → aux（介系詞碰到定冠詞要縮合）' },
  { lesson:33, topic:'cause-consequence', type:'fill', q:"Ils ne peuvent pas faire leur reportage _____ mauvais temps.", hint:'負面原因，碰到 le', a:'à cause du', aNote:'de ＋ le → du；le temps 在這裡是「天氣」' },
  { lesson:33, topic:'cause-consequence', type:'fill', q:"Les jeunes lisent la presse en ligne, _____ ils n'achètent plus le journal papier.", hint:'「所以」，口說版', a:'alors|donc', aNote:'alors 主要用在口說、donc 主要用在書面，都帶出結果（課本練習3b）' },
  { lesson:33, topic:'cause-consequence', type:'fill', q:"Ils n'aiment pas lire les articles en entier, c'est pour cela _____ ne lisent que les titres.", hint:'que 碰到 ils', a:"qu'ils", aNote:"🎙 老師：que 遇到母音開頭要去掉 e → qu'ils（課本練習3d）" },
  { lesson:33, topic:'cause-consequence', type:'fill', q:"Des journalistes utilisent Twitch _____ c'est interactif.（書面的「因為」，三個字母）", hint:'主要用在書面', a:'car', aNote:'car 主要用在書面；parce que 口說書面都可以' },
  { lesson:33, topic:'cause-consequence', type:'choose', q:"「Tu reçois les nouvelles sur ton téléphone, alors tu n'as pas besoin de les chercher.」alors 帶出的是？", hint:'往前指還是往後推', a:'結果（une conséquence）', aNote:"donc／alors／c'est pourquoi 帶結果；parce que／car／grâce à／à cause de 帶原因", opts:['結果（une conséquence）','原因（une cause）','時間（接著）','讓步（雖然）'] },
  { lesson:33, topic:'cause-consequence', type:'choose', q:'下面哪一個主要用在口說？', hint:'ça 是 cela 的口語版', a:"c'est pour ça que", aNote:"c'est pourquoi／c'est pour cela que 是書面；c'est pour ça que 是口說", opts:["c'est pour ça que","c'est pour cela que","c'est pourquoi","car"] },
  { lesson:33, topic:'cause-consequence', type:'choose', q:"J'ai appris beaucoup de choses _____ mon émission préférée.", hint:'學到東西是好事', a:'grâce à', aNote:'正面原因 → grâce à（課本練習2 a-2）', opts:['grâce à','à cause de','parce que','donc'] },
  { lesson:33, topic:'cause-consequence', type:'choose', q:"「Pourquoi tu ne lis que les titres ?」口說回答怎麼開頭？", hint:'car 能不能單獨回答？', a:"Parce qu'ils sont trop longs.", aNote:'⚠️ car 只能夾在兩個句子中間，不能單獨回答 Pourquoi ?（課本音檔 Floriane）', opts:["Parce qu'ils sont trop longs.","Car ils sont trop longs.","Donc ils sont trop longs.","À cause de ils sont trop longs."] },
  { lesson:33, topic:'cause-consequence', type:'choose', q:'口訣「Mais où est donc Ornicar ?」背的是什麼？', hint:'老師補充', a:'七個對等連接詞：mais, ou, et, donc, or, ni, car', aNote:'口訣裡的 où／est 代表的是 ou（或）／et（和）', opts:['七個對等連接詞：mais, ou, et, donc, or, ni, car','七個疑問詞','七個不規則動詞','七個表示原因的介系詞'] },
  { lesson:33, topic:'cause-consequence', type:'choose', q:'「他不壞也不親切。」標準寫法是？', hint:'ni…ni 要配什麼', a:"Il n'est ni méchant ni gentil.", aNote:'⚠️ 老師口語常省 ne（Il est ni…ni…），寫的時候要有 ne', opts:["Il n'est ni méchant ni gentil.","Il est ni méchant ni gentil.","Il n'est ni méchant ou gentil.","Il n'est ni méchant et gentil."] },
  { lesson:33, topic:'cause-consequence', type:'trans', q:"很多人比較喜歡網路新聞，所以她們不再買報紙了。（用 c'est pourquoi）", hint:'personnes 是陰性', a:"Beaucoup de personnes préfèrent la presse en ligne, c'est pourquoi elles n'achètent plus le journal.", aNote:'課本練習3 範例。personnes → elles' },
  { lesson:33, topic:'cause-consequence', type:'trans', q:'他超愛這本雜誌，所以有訂閱。', hint:'結果連接詞 ＋ être abonné', a:"Il adore ce magazine, donc il est abonné.|Il adore ce magazine, alors il est abonné.|Il adore ce magazine, c'est pourquoi il est abonné.|Il adore ce magazine, c'est pour cela qu'il est abonné.", aNote:'課本練習3c，四個結果連接詞都可以' },

  { lesson:33, topic:'medias-vocab', type:'fill', q:'Vous avez vu la _____ ?（那則新聞）', hint:'nouveau 的陰性，這裡當名詞', a:'nouvelle', aNote:"la nouvelle＝一則新聞；l'actualité＝全部的時事" },
  { lesson:33, topic:'medias-vocab', type:'fill', q:'Il adore ce magazine, donc il est _____.（有訂閱）', hint:'un abonnement', a:'abonné', aNote:'être abonné(e) à；名詞 un abonnement' },
  { lesson:33, topic:'medias-vocab', type:'fill', q:'Je regarde toujours le _____ de 20 h.（電視新聞，兩個字母）', hint:'le journal télévisé', a:'JT', aNote:'le JT＝le journal télévisé。🎙 Owen 猜 émission，但前面是 le，émission 是陰性' },
  { lesson:33, topic:'medias-vocab', type:'fill', q:'Sur cette _____, les émissions sont très intéressantes.（頻道）', hint:'une ... télé／Twitch', a:'chaîne', aNote:'une chaîne télé／Twitch／YouTube（Instagram 說 un compte）' },
  { lesson:33, topic:'medias-vocab', type:'fill', q:'Oui, je suis déjà au _____.（我已經知道了）', hint:'也是「電流」', a:'courant', aNote:'être au courant＝savoir, être informé(e)；很口語也說 être au jus' },
  { lesson:33, topic:'medias-vocab', type:'fill', q:'Ils filmaient et commentaient leurs parties en direct à travers le _____.（聊天室）', hint:'不是 chat', a:'tchat', aNote:'⚠️ 拼成 tchat，因為 chat 在法文是貓' },
  { lesson:33, topic:'medias-vocab', type:'choose', q:'每三個月出一本的雜誌是 une revue _____。', hint:'le trimestre', a:'trimestrielle', aNote:'quotidien 每天／hebdomadaire 每週／mensuel 每月／trimestriel 每三個月', opts:['trimestrielle','quotidienne','hebdomadaire','mensuelle'] },
  { lesson:33, topic:'medias-vocab', type:'choose', q:'「le public actuel」是什麼意思？', hint:'假朋友', a:'現在的觀眾', aNote:'⚠️ actuel＝當前的，不是 actual；actuellement＝目前', opts:['現在的觀眾','真實的觀眾','主動的觀眾','實際的觀眾人數'] },
  { lesson:33, topic:'medias-vocab', type:'choose', q:'le magazine 和 le magasin 的差別？', hint:'Owen 截圖手寫過', a:'le magazine＝雜誌；le magasin＝商店', aNote:'le magazine＝la revue', opts:['le magazine＝雜誌；le magasin＝商店','兩個都是雜誌','le magazine＝商店；le magasin＝雜誌','兩個都是商店'] },
  { lesson:33, topic:'medias-vocab', type:'choose', q:'Instagram 上的「帳號」法文說？', hint:'不是頻道', a:'un compte', aNote:'🎙 老師：chaîne 是電視／Twitch／YouTube 的「頻道」，Instagram 不說 chaîne', opts:['un compte','une chaîne','une émission','un numéro'] },
  { lesson:33, topic:'medias-vocab', type:'choose', q:'「Un meilleur contrôle parental sur Internet」屬於哪個欄目？', hint:'課本練習4', a:'la société', aNote:'a écologie／b société／c politique／d économie／e sport／f culture', opts:['la société','la politique',"l'économie",'la culture'] },
  { lesson:33, topic:'medias-vocab', type:'choose', q:'「Qui remportera la finale de la Ligue ?」的 remporter 是？', hint:'emporter＝帶走', a:'贏得', aNote:'🎙 老師：remporter＝把獎盃帶回來＝贏', opts:['贏得','帶走','重播','延後'] },
  { lesson:33, topic:'medias-vocab', type:'choose', q:'課本題6：「une information critique et engagée」的 engagée 是？', hint:'課本答案', a:'表達意見、有立場（prendre parti）', aNote:'課本答案 a. exprimer son opinion, prendre parti', opts:['表達意見、有立場（prendre parti）','不表達任何意見','已經訂婚的','很貴的'] },
  { lesson:33, topic:'medias-vocab', type:'choose', q:'「Le travail de recherche fait par un journaliste」是哪個字？', hint:'課本練習1d', a:"l'enquête", aNote:'🎙 老師：enquête 是挖資料的過程，reportage 常是成品，兩個都算對', opts:["l'enquête",'le titre','la chaîne','le numéro'] },
  { lesson:33, topic:'medias-vocab', type:'trans', q:'很少人買報紙。', hint:'le monde＝人', a:'Très peu de monde achète les journaux.|Très peu de monde achète le journal.', aNote:'🎙 老師的句子。le monde＝人，動詞用單數' },

  { lesson:33, topic:'preference-interet', type:'fill', q:"J'aime _____ lire la presse en ligne.（比較喜歡）", hint:'aimer 是動詞', a:'mieux', aNote:"j'aime mieux＝je préfère；aimer 是動詞 → mieux，不是 meilleur" },
  { lesson:33, topic:'preference-interet', type:'fill', q:'Je préfère les réseaux sociaux _____ médias traditionnels.', hint:'préférer A à B', a:'aux', aNote:'à ＋ les → aux' },
  { lesson:33, topic:'preference-interet', type:'fill', q:"La société m'intéresse le moins, mais ça m'intéresse quand _____.", hint:'還是', a:'même', aNote:'quand même＝還是、仍然（老師幫 Owen 補的後半句）' },
  { lesson:33, topic:'preference-interet', type:'fill', q:'Je suis curieux _____ savoir comment ça fonctionne.', hint:'curieux ＋ 原形', a:'de', aNote:'curieux／curieuse de ＋ 原形' },
  { lesson:33, topic:'preference-interet', type:'choose', q:"「Le sport m'intéresse le plus pour moi.」哪裡要改？", hint:"m' 是什麼", a:"pour moi 多餘——m'intéresse 裡已經有「我」", aNote:'🎙 老師糾正 Owen 的回答', opts:["pour moi 多餘——m'intéresse 裡已經有「我」",'le plus 要改成 le mieux','sport 要加 s','intéresse 要改成 intéressé'] },
  { lesson:33, topic:'preference-interet', type:'choose', q:"「C'est passionnant !」是什麼意思？", hint:'比 intéressant 更強', a:'非常精彩、非常有意思', aNote:'la passion＝熱情；passionnant＝非常有意思', opts:['非常精彩、非常有意思','很有熱情的人','很累人','很普通'] },
  { lesson:33, topic:'preference-interet', type:'choose', q:'「我對他們的生活很感興趣」用人當主詞怎麼說？', hint:'反身動詞', a:"Je m'intéresse à leur vie.", aNote:"人當主詞 → s'intéresser à；東西當主詞 → Ça m'intéresse", opts:["Je m'intéresse à leur vie.","Je suis intéressant à leur vie.","Ça m'intéresse à leur vie.","J'intéresse leur vie."] },
  { lesson:33, topic:'preference-interet', type:'trans', q:'我最有興趣的是體育，因為我超愛棒球。', hint:'原因不用 donc', a:"Le sport m'intéresse le plus parce que j'adore le baseball.|Le sport m'intéresse le plus car j'adore le baseball.", aNote:'Owen 的回答。原因用 parce que／car，⛔ 不用 donc' },
  // ── 第34課：subjonctif présent ＋ 廣播 podcast 與社群詞彙 ＋ 影評 ＋ COD/COI 位置 ──
  { lesson:34, topic:'subjonctif-present', type:'choose', q:"「Il faut que tu ___ (regarder) cette vidéo !」", hint:'-er 動詞、tu', a:'regardes', aNote:'課本 Fonctionnement：-er 動詞 je/tu/il/ils 的虛擬式跟現在式同形', opts:['regardes','regardez','regarder','regardais'] },
  { lesson:34, topic:'subjonctif-present', type:'fill', q:"Il faut que tu _____ (demander) à ta petite-fille comment ça marche.", hint:'虛擬式現在、tu', a:'demandes', aNote:'課本 Entraînement 3a' },
  { lesson:34, topic:'subjonctif-present', type:'fill', q:"Il est indispensable qu'ils _____ (utiliser) ces médias.", hint:'虛擬式現在、ils', a:'utilisent', aNote:'課本 Entraînement 3b' },
  { lesson:34, topic:'subjonctif-present', type:'fill', q:"Il ne faut pas qu'elle _____ (être) tout le temps sur Instagram.", hint:'être 不規則', a:'soit', aNote:'課本 Entraînement 3c：être → que je sois, qu’il soit' },
  { lesson:34, topic:'subjonctif-present', type:'fill', q:"Il est important que vous _____ (avoir) cette information.", hint:'avoir 不規則、vous', a:'ayez', aNote:'課本 Entraînement 3d' },
  { lesson:34, topic:'subjonctif-present', type:'fill', q:"Il faut que nous _____ (manger) vite.", hint:'nous 形＝imparfait', a:'mangions', aNote:'🎙 老師：⛔ 不是 mangeons，nous/vous 借 imparfait，聽得出 i' },
  { lesson:34, topic:'subjonctif-present', type:'fill', q:"Aujourd'hui, il faut absolument que j'_____ (aller) voir l'immigration.", hint:'aller 不規則', a:'aille', aNote:'🎙 老師的例句：aller → que j’aille' },
  { lesson:34, topic:'subjonctif-present', type:'fill', q:"Il est important que j'_____ (avoir) le diplôme pour aller au Canada.", hint:'avoir 不規則、je', a:'aie', aNote:'🎙 老師口說成 j’ai；寫要用虛擬式 aie（同音）' },
  { lesson:34, topic:'subjonctif-present', type:'fill', q:"ils finissent → Il faut que je _____ (finir).", hint:'字根看 ils', a:'finisse', aNote:'🎙 老師：-ir 動詞跟現在式不一樣，ils finissent → finiss- ＋ e' },
  { lesson:34, topic:'subjonctif-present', type:'choose', q:"「C'est très bien que les personnes âgées ___ plus connectées.」", hint:'評價 → 虛擬式', a:'soient', aNote:'課本暖身d：c’est bien que 表達評價 → être 的 ils 形 soient', opts:['soient','sont','soit','être'] },
  { lesson:34, topic:'subjonctif-present', type:'choose', q:'虛擬式 je/tu/il/ils 的字根要看現在式哪一格？', hint:'3e personne du pluriel', a:'ils（去掉 -ent）', aNote:'課本：ils informent → que j’informe；nous/vous 才看 imparfait。🎙 當堂一開始指到 il（單數）', opts:['ils（去掉 -ent）','il（去掉 -t）','nous（去掉 -ons）','原形動詞'] },
  { lesson:34, topic:'subjonctif-present', type:'choose', q:"「Il faut faire à manger」和「Il faut que tu fasses à manger」差在哪？", hint:'有沒有指定人', a:'第二句指定「你」去做，第一句是泛指', aNote:'il faut ＋ 原形＝泛指；il faut que ＋ 虛擬式＝指定某人。🎙 老師覺得 il faut que 比命令委婉（他的語感）', opts:['第二句指定「你」去做，第一句是泛指','兩句完全一樣','第二句是過去式','第一句比較不禮貌'] },
  { lesson:34, topic:'subjonctif-present', type:'trans', q:'你在社群網路上要小心。（用 il faut que）', hint:'faire 不規則', a:"Il faut que tu fasses attention sur les réseaux sociaux.", aNote:'課本 Entraînement 4a：Tu dois faire attention → Il faut que tu fasses attention' },
  ...
  { lesson:34, topic:'medias-audio-reseaux', type:'fill', q:"C'est grâce à elle qu'on reconnaît une personne à la radio : la _____.", hint:'聲音', a:'voix', aNote:'p.119 練習1c。c’est grâce à elle que…＝就是靠它…' },
  { lesson:34, topic:'medias-audio-reseaux', type:'fill', q:"C'est décidé. Elle va _____ Tiktok.", hint:'離開社群網路', a:'quitter', aNote:'p.119 練習2a' },
  { lesson:34, topic:'medias-audio-reseaux', type:'fill', q:"Je ne veux pas être _____ tout le temps. Parfois j'éteins mon smartphone tout le week-end.", hint:'在線上', a:'connecté|connectée', aNote:'p.119 練習2b' },
  { lesson:34, topic:'medias-audio-reseaux', type:'fill', q:"Comment on fait pour _____ des photos sur Instagram ?", hint:'貼', a:'poster', aNote:'p.119 練習2c' },
  { lesson:34, topic:'medias-audio-reseaux', type:'fill', q:"C'est bien de _____ les photos des gens qu'on suit !", hint:'留言', a:'commenter', aNote:'p.119 練習2d。qu’on suit＝suivre' },
  { lesson:34, topic:'medias-audio-reseaux', type:'fill', q:"Les radios _____ de l'information.", hint:'散播（複數）', a:'diffusent', aNote:'p.119 練習4a' },
  { lesson:34, topic:'medias-audio-reseaux', type:'fill', q:"Des émissions essayent de _____ les jeunes aux dangers des réseaux sociaux.", hint:'讓…意識到', a:'sensibiliser', aNote:'p.119 練習4d：sensibiliser qn à qch' },
  { lesson:34, topic:'medias-audio-reseaux', type:'trans', q:'多虧了 podcast，我們可以傳遞知識。', hint:'grâce à ＋ les', a:"Grâce aux podcasts, on peut transmettre des connaissances.", aNote:'p.119 練習4b；回鍋第33課 grâce aux' },
  { lesson:34, topic:'medias-audio-reseaux', type:'choose', q:'「les infox」是什麼？', hint:'info ＋ intox', a:'假新聞', aNote:'課文E。🎙 老師：info ＋ intox（intoxication）＝ les fausses nouvelles', opts:['假新聞','資訊科技','網友','廣播節目'] },
  { lesson:34, topic:'medias-audio-reseaux', type:'choose', q:"「l'internaute」是什麼？", hint:'在網路上的人', a:'網友、上網的人', aNote:'課文E。🎙 Tu es internaute, je suis internaute', opts:['網友、上網的人','網路公司','記者','網路'] },
  { lesson:34, topic:'medias-audio-reseaux', type:'choose', q:"「un passe-temps」是什麼？", hint:'passer le temps', a:'消遣、休閒嗜好', aNote:'🎙 當堂以為是「很花時間」。Mon passe-temps, c’est de jouer au tennis.', opts:['消遣、休閒嗜好','很花時間的事','過去的時代','時間表'] },
  { lesson:34, topic:'medias-audio-reseaux', type:'choose', q:"「se méfier」是什麼意思？", hint:'課文E 註2', a:'提防、不輕易相信', aNote:'課本註：faire attention, ne pas faire confiance', opts:['提防、不輕易相信','抱怨','放心','參加'] },
  { lesson:34, topic:'medias-audio-reseaux', type:'choose', q:"「montrer la science en train de se faire」的 en train de 是什麼？", hint:'Je suis en train de manger', a:'正在…（進行中）', aNote:'🎙 老師：en train de＝正在做', opts:['正在…（進行中）','已經做完','將要','應該要'] },

  { lesson:34, topic:'critique-film', type:'choose', q:"「Ce film m'a beaucoup plu.」的 plu 是哪個動詞？", hint:'s’il vous plaît', a:'plaire（讓人喜歡）', aNote:'🎙 ça me plaît → ça m’a plu。主詞是電影，喜歡的人是 me', opts:['plaire（讓人喜歡）','pleuvoir（下雨）','plus（更多）','pouvoir（可以）'] },
  { lesson:34, topic:'critique-film', type:'choose', q:"「Mes enfants aussi ; le film leur a beaucoup plu !」是誰喜歡電影？", hint:'leur', a:'我的小孩', aNote:'課本 Nath T.：leur＝à mes enfants（COI）', opts:['我的小孩','電影','我','導演'] },
  { lesson:34, topic:'critique-film', type:'choose', q:'哪一句是負面評論？', hint:'Pour faire une critique négative', a:"Je l'ai trouvé nul.", aNote:'課本 Pour faire une critique', opts:["Je l'ai trouvé nul.","C'est très bien filmé !","Ce film est une bonne surprise.","J'ai bien aimé."] },
  { lesson:34, topic:'critique-film', type:'fill', q:"Je n'ai pas du tout _____.", hint:'一點也不喜歡', a:'aimé', aNote:'課本 Charles B.' },
  { lesson:34, topic:'critique-film', type:'fill', q:"Je pensais voir un bon film historique, mais il est très _____.", hint:'無聊的', a:'ennuyeux', aNote:'課本 Charles B.' },
  { lesson:34, topic:'critique-film', type:'fill', q:"L'histoire d'amour prend beaucoup trop de _____.", hint:'佔太多份量', a:'place', aNote:'課本 Caro F.。🎙 prendre trop de place' },
  { lesson:34, topic:'critique-film', type:'choose', q:"「Je t'aime bien」和「Je t'aime」差在哪？", hint:'對人', a:"Je t'aime bien 比較輕（朋友式喜歡）", aNote:'🎙 老師：對人差很多；對東西（j’aime bien le foot）幾乎一樣', opts:["Je t'aime bien 比較輕（朋友式喜歡）",'兩句完全一樣',"Je t'aime bien 比較強烈","Je t'aime bien 是過去式"] },
  { lesson:34, topic:'critique-film', type:'choose', q:"「Tu me plais.」通常是什麼意思？", hint:'plaire 用在人身上', a:'我覺得你很有魅力', aNote:'🎙 老師：偏外表的吸引。主詞是被喜歡的人', opts:['我覺得你很有魅力','請你幫我','你讓我很煩','你喜歡我'] },
  { lesson:34, topic:'critique-film', type:'trans', q:'這部電影是個驚喜，我推薦給所有 Romain Duris 的粉絲。', hint:'le 放動詞前', a:"Ce film est une bonne surprise, je le conseille à tous les fans de Romain Duris.", aNote:'課本 Seb_32' },

  { lesson:34, topic:'place-pronoms-cod-coi', type:'fill', q:"La télé ? Elle ne _____ regarde jamais.", hint:'COD', a:'la', aNote:'p.121 練習2a' },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'fill', q:"Un journaliste a interviewé ma sœur. Il _____ a posé des questions intéressantes.", hint:'poser à qui', a:'lui', aNote:'p.121 練習2b：COI 放助動詞前' },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'fill', q:"Les journaux, elle préfère _____ lire en ligne.", hint:'兩個動詞', a:'les', aNote:'p.121 練習2c：代名詞貼 lire' },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'fill', q:"Ses amis ? Il _____ parle tous les jours sur les réseaux sociaux.", hint:'parler à qui', a:'leur', aNote:'p.121 練習2d' },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'trans', q:'我們要去電影院看它。（它＝這部電影）', hint:'futur proche', a:"Nous allons le voir au cinéma.", aNote:'p.121 練習3a：放原形前' },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'trans', q:'這個頻道不會播它。（它＝我們最喜歡的影集）', hint:'la série', a:"Cette chaîne ne va pas la diffuser.", aNote:'p.121 練習3b' },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'trans', q:'我沒看它。（它＝最後一集）', hint:"le ＋ ai → l'ai", a:"Je ne l'ai pas vu.", aNote:'p.121 練習3c：複合時態放助動詞前' },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'trans', q:'我建議他們看這部影集。（他們＝我爸媽，用代名詞）', hint:'conseiller à qn de', a:"Je leur ai conseillé de regarder cette série.", aNote:'p.121 練習3d' },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'choose', q:"「Les premières scènes, je les ai trouvées nulles.」為什麼是 trouvées？", hint:'COD 在 avoir 前', a:'COD les（陰性複數）放在 avoir 前，過去分詞要配合', aNote:'課本 Nath T.。⚠️ COI 在前不配合：le film leur a plu', opts:['COD les（陰性複數）放在 avoir 前，過去分詞要配合','因為主詞是 je','因為 trouver 用 être 當助動詞','打錯了，應該是 trouvé'] },
  { lesson:34, topic:'place-pronoms-cod-coi', type:'choose', q:"「Je vais le regarder.」的否定句是？", hint:'ne…pas 夾住變位動詞', a:'Je ne vais pas le regarder.', aNote:'課本 Fonctionnement', opts:['Je ne vais pas le regarder.','Je ne le vais pas regarder.','Je vais ne pas le regarder.','Je ne vais le pas regarder.'] },

  // ═══ 第35課（Édito A2 Unité 9 Consommer responsable，p.125–132）═══
  // ⛔ 全部出自課本或老師課堂用語，Claude 不自創法文（CLAUDE.md 內容鐵律）
  { lesson:35, topic:'conditionnel-present', type:'choose', q:"「Ça te dirait d'en discuter ?」是條件式的哪一種用途？", hint:'課本 Fonctionnement 四格', a:'提議（proposer quelque chose）', aNote:'⚠️ 09-22 對答案時這一格填成 a（願望）。a 是 J\'aimerais…＝願望，c 才是提議。記法：Ça te dirait…? 開頭的就是在提議', opts:['提議（proposer quelque chose）','表達願望（exprimer un souhait）','禮貌請求（demande polie）','給建議（donner un conseil）'] },
  { lesson:35, topic:'conditionnel-present', type:'choose', q:'條件式現在的「字尾」跟哪個時態一樣？', hint:'-ais, -ais, -ait, -ions, -iez, -aient', a:'未完成過去（imparfait）', aNote:'⭐ 詞幹跟未來式一樣（原形），字尾跟 imparfait 一樣——零件全是借的', opts:['未完成過去（imparfait）','簡單未來（futur simple）','複合過去（passé composé）','虛擬式（subjonctif）'] },
  { lesson:35, topic:'conditionnel-present', type:'choose', q:'nous aimerions 和 nous aimerons 差在哪？', hint:'差一個字母', a:'aimerions 是條件式（多一個 i），aimerons 是未來式', aNote:'⚠️ 🎙 老師：futur 沒有那個 i', opts:['aimerions 是條件式（多一個 i），aimerons 是未來式','aimerions 是未來式，aimerons 是條件式','兩個一樣，只是拼法不同','aimerions 是過去式'] },
  { lesson:35, topic:'conditionnel-present', type:'choose', q:'elle aimait 和 elle aimerait 差在哪？', hint:'差一個字母', a:'aimait 是「以前喜歡」，aimerait 是「會想要」（多一個 r）', aNote:'⭐ 有 r 就是條件式；這兩個最容易聽混', opts:['aimait 是「以前喜歡」，aimerait 是「會想要」（多一個 r）','aimait 是「會想要」，aimerait 是「以前喜歡」','兩個都是過去式','兩個都是條件式'] },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Nous _____ (pouvoir) participer à ce défi.', hint:'條件式、nous', a:'pourrions', aNote:'課本 Entraînement 3a。pouvoir → pourr-' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Elle _____ (aimer) acheter un pull.', hint:'條件式、elle', a:'aimerait', aNote:'課本 Entraînement 3b。⚠️ 不是 aimait（那是 imparfait）' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Vous _____ (devoir) négocier le prix.', hint:'條件式、vous', a:'devriez', aNote:'課本 Entraînement 3e。devoir → devr-' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Nous _____ (aimer) essayer.', hint:'條件式、nous（願望）', a:'aimerions', aNote:'課本 Entraînement 4a' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Elles _____ (souhaiter) emprunter des livres.', hint:'條件式、elles（願望）', a:'souhaiteraient', aNote:'課本 Entraînement 4b' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Ça te _____ (dire) de faire des achats avec moi ?', hint:'條件式、提議', a:'dirait', aNote:'課本 Entraînement 4c。⭐ Ça te dirait de…＝你想…嗎' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Je _____ (vouloir) une baguette, s\'il vous plaît !', hint:'條件式、禮貌請求', a:'voudrais', aNote:'課本 Entraînement 4d。⭐⭐ 老師指定「最重要」的三個之一' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'On _____ (pouvoir) louer des kayaks !', hint:'條件式、提議', a:'pourrait', aNote:'課本 Entraînement 4e。⭐ On pourrait…＝我們可以…啊（提議）' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Tu _____ (devoir) regarder ce forum.', hint:'條件式、建議', a:'devrais', aNote:'課本 Entraînement 4f' },
  { lesson:35, topic:'conditionnel-present', type:'fill', q:'Vous _____ (avoir) des idées, s\'il vous plaît ?', hint:'條件式、禮貌請求', a:'auriez', aNote:'課本 Entraînement 4g。avoir → aur-' },
  { lesson:35, topic:'conditionnel-present', type:'trans', q:'我想要一杯咖啡。（禮貌）', hint:'vouloir 的條件式', a:'Je voudrais un café.', aNote:'課本 Remarques。⭐⭐ 整塊背起來，不要每次重組' },
  ...
  { lesson:35, topic:'gerondif', type:'choose', q:'「我一邊跟他講話一邊做園藝」的代名詞 lui 要放哪裡？', hint:'課本 Remarques', a:'夾在 en 和動詞中間：en lui parlant', aNote:'課本原句 Je fais du jardinage en lui parlant.', opts:['夾在 en 和動詞中間：en lui parlant','放在 en 前面：lui en parlant','放在動詞後面：en parlant lui','放句首：Lui je fais du jardinage en parlant'] },
  { lesson:35, topic:'gerondif', type:'choose', q:'gérondif 回答的是哪兩種問題？', hint:'課本 Emploi', a:'什麼時候（同時）＋ 怎麼做到的（方式）', aNote:'Il travaille en chantant（同時）／Elle est venue en courant（方式，回答 comment ?）', opts:['什麼時候（同時）＋ 怎麼做到的（方式）','為什麼＋在哪裡','誰做的＋做給誰','做多久＋做幾次'] },
  { lesson:35, topic:'gerondif', type:'fill', q:'Elles cuisinent _____ (écouter) de la musique.', hint:'en ＋ -ant', a:'en écoutant', aNote:'課本課文D 原句（同時）' },
  { lesson:35, topic:'gerondif', type:'fill', q:'Elles tricotent _____ (regarder) la télévision.', hint:'en ＋ -ant', a:'en regardant', aNote:'課本課文D 原句（同時）' },
  { lesson:35, topic:'gerondif', type:'fill', q:'J\'apprends la mécanique _____ (regarder) des tutoriels.', hint:'en ＋ -ant', a:'en regardant', aNote:'課本 Entraînement 2a（方式）' },
  { lesson:35, topic:'gerondif', type:'fill', q:'Il a vendu son vélo _____ (mettre) une annonce sur Leboncoin.', hint:'nous mettons → ?', a:'en mettant', aNote:'課本 Entraînement 2b（方式）' },
  { lesson:35, topic:'gerondif', type:'fill', q:'On mange mieux _____ (cuisiner) soi-même.', hint:'en ＋ -ant', a:'en cuisinant', aNote:'課本 Entraînement 2c（方式）' },
  { lesson:35, topic:'gerondif', type:'fill', q:'Je regarde des blogs créatifs _____ (boire) un café.', hint:'nous buvons → ?', a:'en buvant', aNote:'課本 Entraînement 3e。⚠️ 要先過 nous：boire → nous buvons → buvant' },
  ...
  { lesson:35, topic:'vocab-consommation', type:'fill', q:'On pourrait _____ une voiture ce week-end !', hint:'租', a:'louer', aNote:'課本 p.129 練習1c。⚠️ louer→la location，⛔ 不是英文的 location（地點）' },
  { lesson:35, topic:'vocab-consommation', type:'fill', q:'Excusez-moi, est-ce que je pourrais _____ votre stylo ?', hint:'借進來', a:'emprunter', aNote:'課本 p.129 練習1e。⚠️ emprunter＝借入，prêter＝借出' },
  { lesson:35, topic:'vocab-consommation', type:'fill', q:'Vous devriez _____ vos livres avec votre famille.', hint:'共享', a:'partager', aNote:'課本 p.129 練習1g。⚠️ 09-22 當堂問過「partager 也是丟掉嗎」——不是，是兩個人一起用' },
  { lesson:35, topic:'vocab-consommation', type:'choose', q:'neuf 的相反詞是？', hint:'本課核心對比', a:"d'occasion（二手）", aNote:'⚠️ en promotion 的東西還是 neuf，只是打折；de seconde main＝口語的二手', opts:["d'occasion（二手）",'en promotion（特價）','gratuit（免費）','cher（貴）'] },
  { lesson:35, topic:'vocab-consommation', type:'choose', q:'「Tu as pensé à la location ?」的 location 是什麼意思？', hint:'⚠️ 假朋友', a:'租賃（用租的）', aNote:'⚠️⚠️ ⛔ 不是英文的 location（地點）！動詞是 louer', opts:['租賃（用租的）','地點、位置','分店','行李寄放'] },
  { lesson:35, topic:'vocab-consommation', type:'choose', q:'「un mouchoir en tissu」的 tissu 是什麼？', hint:'⚠️ 假朋友', a:'布料（fabric）', aNote:'⚠️⚠️ ⛔ 不是英文的 tissue（面紙）。mouchoir 來自 moucher（擤鼻涕）', opts:['布料（fabric）','面紙','紙巾盒','手套'] },
  { lesson:35, topic:'vocab-consommation', type:'choose', q:'「Déjà, ton annonce doit être complète.」的 déjà 是什麼意思？', hint:'⚠️ 不是最常見的那個意思', a:'首先', aNote:'⚠️ 09-22 老師當堂考過。同一篇最後的 j\'ai déjà trouvé une cliente 才是「已經」', opts:['首先','已經','再一次','從來沒有'] },
  { lesson:35, topic:'vocab-consommation', type:'choose', q:'洗衣機、冰箱屬於哪一類？', hint:'課本 p.129 catégories', a:"l'électroménager", aNote:'🎙 老師：家裡用電的、偏清潔與烹飪的；電視電腦是 le multimédia（偏娛樂）', opts:["l'électroménager",'le multimédia','le meuble','le matériel de sport'] },
  { lesson:35, topic:'vocab-consommation', type:'choose', q:'un particulier 指的是誰？', hint:'相對於「公司」', a:'個人（不是企業）', aNote:'🎙 老師：C2C 的那個 C；particulier à particulier＝個人對個人交易', opts:['個人（不是企業）','店長','常客','網站使用者'] },
  { lesson:35, topic:'vocab-consommation', type:'choose', q:'「Rien de neuf」挑戰⛔ 不包含哪兩類？', hint:'課本貼文說明', a:'食品和美妝品（l\'alimentation／les produits de beauté）', aNote:'課本原文：Ça ne concerne pas l\'alimentation ou les produits de beauté.', opts:["食品和美妝品（l'alimentation／les produits de beauté）",'家電和家具','衣服和運動器材','書和電腦'] },
  { lesson:35, topic:'vocab-consommation', type:'trans', q:'我在 Leboncoin 上賣衣服，但都賣不掉。', hint:'essayer de / sans succès', a:"J'essaie de vendre des vêtements sur Leboncoin mais sans succès.", aNote:'課本 p.127 原句' },
  { lesson:35, topic:'vocab-consommation', type:'trans', q:'這是省錢的好方法。', hint:'un bon moyen de', a:"C'est un bon moyen d'économiser.", aNote:'課本 p.126 留言原句' },
  { lesson:35, topic:'vocab-consommation', type:'trans', q:'每件衣服的品牌、尺寸和顏色都要註明。', hint:'Il faut préciser…', a:'Il faut préciser la marque, la taille et la couleur de chaque vêtement.', aNote:'課本 p.127 原句（給建議）' },
  // ── 第36課（09-24）：Unité 9 收尾＋Unité 10 開頭（p.132–142）──
  { lesson:36, topic:'pc-imparfait-recit', type:'choose', q:'講過去的故事時，imparfait 負責什麼？', hint:'課本 p.142 Fonctionnement', a:'描述情境（地方、人、狀態），持續中的動作', aNote:'🎙 老師：something that lasts。passé composé 才是帶出新動作、轉變', opts:['描述情境（地方、人、狀態），持續中的動作','帶出一個新的動作、一個轉變','只用在很久以前的事','只用在否定句'] },
  { lesson:36, topic:'pc-imparfait-recit', type:'choose', q:'soudain／tout à coup／quand 這幾個時間標記通常搭配哪個時態？', hint:'「突然」發生的事', a:'passé composé', aNote:'課本：passé composé 常跟 soudain、tout à coup、quand 一起出現', opts:['passé composé','imparfait','futur simple','conditionnel'] },
  { lesson:36, topic:'pc-imparfait-recit', type:'choose', q:'Nous _____ dans l\'avion. Soudain, je me suis senti mal.', hint:'課本 p.142 練習3a', a:'étions', aNote:'在飛機上＝場景 → imparfait；突然不舒服＝事件 → passé composé', opts:['étions','avons été','serons','serions'] },
  { lesson:36, topic:'pc-imparfait-recit', type:'choose', q:'Elle marchait en montagne quand elle _____ un animal.', hint:'課本 p.142 練習3b', a:'a entendu', aNote:'🎙 老師：這題沒寫 soudain，但 quand 帶出的就是突然發生的事', opts:['a entendu','entendait','entend','entendrait'] },
  { lesson:36, topic:'pc-imparfait-recit', type:'choose', q:'Vous _____ un vol pas cher et vous avez vu cette offre.', hint:'課本 p.142 練習3c', a:'cherchiez', aNote:'正在找（持續）→ imparfait；看到（一次）→ passé composé', opts:['cherchiez','avez cherché','chercherez','chercheriez'] },
  { lesson:36, topic:'pc-imparfait-recit', type:'choose', q:'J\'étais dans un musée. _____ Marc passer.', hint:'課本 p.142 練習3d', a:"J'ai vu", aNote:'🎙 老師：最常見的形式——先 imparfait 搭場景，再 passé composé 帶出別的事', opts:["J'ai vu",'Je voyais','Je verrai','Je vois'] },
  { lesson:36, topic:'pc-imparfait-recit', type:'fill', q:'On _____ (se balader) dans les rues de la ville. Un orage a éclaté.', hint:'課本 p.142 練習4a，場景', a:'se baladait', aNote:'散步中＝背景 → imparfait' },
  { lesson:36, topic:'pc-imparfait-recit', type:'fill', q:'On se baladait dans les rues. Un orage _____ (éclater), on a couru pour se mettre à l\'abri.', hint:'課本 p.142 練習4a，突發', a:'a éclaté', aNote:'🎙 老師：如果是「以前常常這樣」就改 imparfait：des orages qui éclataient et on courait…' },
  { lesson:36, topic:'pc-imparfait-recit', type:'fill', q:'Un orage a éclaté, on _____ (courir) pour se mettre à l\'abri.', hint:'課本 p.142 練習4a', a:'a couru', aNote:'⚠️ Owen 當堂問拼字：c-o-u-r-u' },
  { lesson:36, topic:'pc-imparfait-recit', type:'fill', q:'Tout à coup, un tableau _____ (tomber).', hint:'課本 p.142 練習4b，⚠️ 助動詞', a:'est tombé', aNote:'tomber 用 être' },
  { lesson:36, topic:'pc-imparfait-recit', type:'fill', q:'Nous ne voyions pas la terre. Soudain, nous _____ (apercevoir) Nice !', hint:'課本 p.142 練習4c', a:'avons aperçu', aNote:'apercevoir＝遠遠看到；過去分詞 aperçu（ç）' },
  { lesson:36, topic:'pc-imparfait-recit', type:'fill', q:'Il regardait la mer quand il a vu des dauphins sauter dans l\'eau, c\'_____ (être) magique !', hint:'課本 p.142 練習4d，講感受', a:'était', aNote:'描述感受、氣氛 → imparfait' },
  { lesson:36, topic:'pc-imparfait-recit', type:'fill', q:'Sur le chemin du retour, j\'_____ (perdre) l\'équilibre et je suis tombé.', hint:'課本 p.142 練習5', a:'ai perdu', aNote:'perdre l\'équilibre＝失去平衡' },
  { lesson:36, topic:'pc-imparfait-recit', type:'fill', q:'Je me suis blessé au genou, mais ce n\'_____ (être) pas grave.', hint:'課本 p.142 練習5', a:'était', aNote:'狀態描述 → imparfait' },
  { lesson:36, topic:'pc-imparfait-recit', type:'choose', q:'「Il était en route vers le Mexique quand il a eu l\'idée…」為什麼後半用 passé composé？', hint:'🎙 老師的說法', a:'標出改變人生的那一刻（一次、有衝擊）', aNote:'🎙 老師：用 imparfait 的話衝擊感就不見了', opts:['標出改變人生的那一刻（一次、有衝擊）','因為 quand 後面一定要用 passé composé','因為 avoir 沒有 imparfait','因為那是很久以前的事'] },
  { lesson:36, topic:'pc-imparfait-recit', type:'trans', q:'我們在安地斯山，已經走了好幾個小時。', hint:'課本 p.142 練習5，imparfait', a:'Nous étions dans les Andes. Nous marchions depuis des heures.', aNote:'兩個都是場景 → imparfait' },
  { lesson:36, topic:'pc-imparfait-recit', type:'trans', q:'我們在飛機上。突然我覺得不舒服。', hint:'soudain', a:'Nous étions dans l\'avion. Soudain, je me suis senti mal.', aNote:'課本 p.142 練習3a' },

  { lesson:36, topic:'conditionnel-present', type:'choose', q:'第36課 conditionnel 的新用途是什麼？', hint:'課本 p.135 Fonctionnement (2)', a:'想像不是真的事、做假設', aNote:'第35課是把話說軟（請求／願望／建議／提議），這課是 imaginer, faire des hypothèses', opts:['想像不是真的事、做假設','講以前的習慣','命令別人','講一定會發生的未來'] },
  { lesson:36, topic:'conditionnel-present', type:'choose', q:'Nous n\'achèterons pas de choses inutiles. ／ Nous n\'achèterions pas de choses inutiles. 差在哪？', hint:'🎙 老師的分法', a:'-ons 是宣布決定（未來式），-ions 是想像（條件式）', aNote:'⚠️ Owen 當堂問「是 -ons 還是 -ions？」', opts:['-ons 是宣布決定（未來式），-ions 是想像（條件式）','兩個意思一樣','-ions 是過去式','-ons 比較客氣'] },
  { lesson:36, topic:'conditionnel-present', type:'choose', q:'請朋友幫忙，哪一句比較客氣？', hint:'🎙 老師：一句聽起來像在逼對方', a:"Tu m'aiderais à réparer ma voiture ?", aNote:'aideras（futur）像在逼；aiderais（conditionnel）比較客氣、對方比較會答應', opts:["Tu m'aiderais à réparer ma voiture ?","Tu m'aideras à réparer ma voiture ?","Tu m'aides à réparer ma voiture ?","Tu m'as aidé à réparer ma voiture ?"] },
  { lesson:36, topic:'conditionnel-present', type:'choose', q:'標準法文裡，si 後面接 imparfait 時，主句用什麼？', hint:'Si j\'avais des week-ends de quatre jours, j\'_____ plus de temps.', a:'conditionnel（j\'aurais）', aNote:'si＋présent → futur（第25課）；si＋imparfait → conditionnel。⛔ 兩組不能交叉', opts:['conditionnel（j\'aurais）','futur（j\'aurai）','présent（j\'ai）','passé composé（j\'ai eu）'] },
  { lesson:36, topic:'conditionnel-present', type:'fill', q:'On _____ (échanger) nos vêtements.', hint:'課本 p.135 練習2b', a:'échangerait', aNote:'⚠️ 當堂一開始說 on échange。🎙 老師：字尾想成 imparfait，前面有 r' },
  { lesson:36, topic:'conditionnel-present', type:'fill', q:'Je _____ (faire) du troc de livres.', hint:'課本 p.135 練習2c', a:'ferais', aNote:'faire → fer-' },
  { lesson:36, topic:'conditionnel-present', type:'fill', q:'Tous les gens _____ (être) des consommateurs responsables.', hint:'課本 p.135 練習2d', a:'seraient', aNote:'être → ser-' },
  { lesson:36, topic:'conditionnel-present', type:'fill', q:'Il n\'y _____ (avoir) pas de problèmes écologiques.', hint:'課本 p.135 練習2e', a:'aurait', aNote:'avoir → aur-' },
  { lesson:36, topic:'conditionnel-present', type:'fill', q:'La planète _____ (se porter) bien.', hint:'課本 p.135 練習2f', a:'se porterait', aNote:'se porter bien＝狀況良好' },
  { lesson:36, topic:'conditionnel-present', type:'fill', q:'Vous _____ (devoir) essayer le troc, c\'est très bien !', hint:'課本 p.136 練習1a', a:'devriez', aNote:'⚠️ 當堂唸成 devrir。詞幹 devr-' },
  { lesson:36, topic:'conditionnel-present', type:'fill', q:'On _____ (pouvoir) proposer nos services dans une accorderie !', hint:'課本 p.136 練習1c', a:'pourrait', aNote:'⚠️ 兩個 r：p-o-u-r-r-ait' },

  { lesson:36, topic:'gerondif', type:'trans', q:'他靠看 Netflix 讓法文進步。', hint:'課本 p.136 練習2b，en＋-ant', a:'Il a amélioré son français en regardant Netflix.', aNote:'🎙 老師示範。gérondif 表方式' },
  { lesson:36, topic:'gerondif', type:'trans', q:'我們是去上課學會縫紉的。', hint:'課本 p.136 練習2c，prendre → prenant', a:'Nous avons appris à coudre en prenant un cours.', aNote:'🎙 老師示範' },
  { lesson:36, topic:'gerondif', type:'choose', q:'🎙 老師說在 YouTube 聽到「Gagner de l\'argent en dormant」通常代表什麼？', hint:'en dormant＝睡覺的同時', a:'多半是詐騙', aNote:'🎙 買我的 ETF 睡覺也能賺錢……', opts:['多半是詐騙','一種合法的投資建議','一種睡眠療法','一個法國俗語，意思是很努力'] },

  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'monter un meuble 是什麼意思？', hint:'🎙 老師舉 IKEA 當例子', a:'組裝家具', aNote:'⚠️ 不是搬上樓。fabriquer 才是從零開始自己做', opts:['組裝家具','把家具搬上樓','買一件家具','修理家具'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'verser une caution 是什麼意思？', hint:'⚠️ 假朋友', a:'付押金', aNote:'caution＝押金（une garantie），不是英文的 caution（小心）', opts:['付押金','小心一點','付罰款','付月租'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'冰箱自己不動了，老師會說？', hint:'🎙 老師：cassé 是真的摔壞', a:'Mon frigo est en panne.', aNote:'電器自己停掉 → en panne；摔壞 → cassé；刮傷但能用 → abîmé', opts:['Mon frigo est en panne.','Mon frigo est abîmé.','Mon frigo est neuf.','Mon frigo est gratuit.'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'abîmé 是什麼狀態？', hint:'🎙 老師的解釋', a:'有損傷、看起來舊了，但還能用', aNote:'cassé＝壞了；en panne＝故障不動', opts:['有損傷、看起來舊了，但還能用','完全壞掉了','全新的','被偷了'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'couper du bois 要用哪個工具？', hint:'課本 p.133 練習4a', a:'une scie', aNote:'b 梯子 une échelle、c 割草機 une tondeuse', opts:['une scie','une échelle','une tondeuse','une ponceuse'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'peindre le haut d\'un mur 需要什麼？', hint:'課本 p.133 練習4b', a:'une échelle', aNote:'échelle＝梯子', opts:['une échelle','une scie','un rasoir','une tondeuse'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'「J\'ai acheté de la laine.」屬於哪一種手作？', hint:'課本 p.133 練習1a', a:'le tricot', aNote:'🎙 老師：une pelote de laine＝一球毛線', opts:['le tricot','la mécanique','la décoration','la cuisine'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'une pièce 在「changer une pièce」裡是什麼？', hint:'⚠️ 一詞多義', a:'零件', aNote:'也可以是硬幣（une pièce d\'un euro）或房間', opts:['零件','硬幣','房間','一齣戲'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'avoir la main verte 是什麼意思？', hint:'課本 p.134 Fanny 的信', a:'很會種植物', aNote:'🎙 中文說綠手指，法文說綠「手」', opts:['很會種植物','手很髒','很嫉妒','很會賺錢'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'avoir l\'embarras du choix 是好事還是壞事？', hint:'課本註：beaucoup de choix', a:'好事——選擇多到挑不完', aNote:'🎙 embarras 本來是尷尬，但這個片語是好事', opts:['好事——選擇多到挑不完','壞事——很尷尬','壞事——沒得選','跟選擇無關'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'Le jardinage me manque. 是什麼意思？', hint:'⚠️ manquer 倒過來', a:'我很想念園藝。', aNote:'想念的東西當主詞，人放 me', opts:['我很想念園藝。','我不會園藝。','園藝少了一個我。','我錯過了園藝課。'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'améliorer 和 s\'améliorer 差在哪？', hint:'🎙 Apple a amélioré le téléphone.', a:'améliorer 改進某樣東西；s\'améliorer 自己進步', aNote:'Je m\'améliore vite en français.', opts:['améliorer 改進某樣東西；s\'améliorer 自己進步','意思完全一樣','s\'améliorer 只用在過去式','améliorer 只用在人'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'啟事寫「Je donne…」代表什麼？', hint:'課本 p.137 Pour écrire une annonce', a:'免費送', aNote:'Je cherche＝徵求；Je propose de＋原形＝通常是提供服務', opts:['免費送','要賣','要借','要租'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'choose', q:'Parmi les catégories ci-dessous 的 ci 是什麼？', hint:'⚠️ 當堂以為是 si', a:'這裡（ci-dessous＝下面這些）', aNote:'ci-dessus＝上面、ci-joint＝附件。跟 si（如果）、scie（鋸子）同音', opts:['這裡（ci-dessous＝下面這些）','如果','鋸子','是的'] },
  { lesson:36, topic:'vocab-travail-manuel', type:'fill', q:'On peut _____ de l\'argent dans les magasins.', hint:'課本 p.136 練習3d', a:'dépenser', aNote:'⚠️ 當堂一開始填 négocier（那是 3e）' },
  { lesson:36, topic:'vocab-travail-manuel', type:'trans', q:'您能告訴我要怎麼做嗎？', hint:'倒裝＋conditionnel', a:'Pourriez-vous m\'expliquer comment faire ?', aNote:'課本 p.134「demander un service」框' },
  { lesson:36, topic:'vocab-travail-manuel', type:'trans', q:'它是什麼材質？', hint:'課本 p.137', a:'En quelle matière il est ?', aNote:'⚠️ 當堂以為 matière 是 work' },

  { lesson:36, topic:'vocab-voyage-sur-mesure', type:'choose', q:'un voyage sur mesure 是什麼？', hint:'🎙 un vêtement sur mesure', a:'照你的喜好量身訂做的行程', aNote:'不是賣給每個人的套裝行程', opts:['照你的喜好量身訂做的行程','很便宜的行程','團體旅遊','只去一個城市的行程'] },
  { lesson:36, topic:'vocab-voyage-sur-mesure', type:'choose', q:'les incontournables 指的是什麼？', hint:'🎙 contourner＝繞過', a:'必去景點', aNote:'🎙 台北就是 101、中正紀念堂', opts:['必去景點','繞路','很難去的地方','當地人'] },
  { lesson:36, topic:'vocab-voyage-sur-mesure', type:'choose', q:'「il est par ici」跟「il est ici」差在哪？', hint:'🎙 老師找手機的例子', a:'par ici 是「大概在這附近」，不確定確切位置', aNote:'知道確切位置就直接 il est ici', opts:['par ici 是「大概在這附近」，不確定確切位置','par ici 比較有禮貌','par ici 是過去式','沒有差別'] },
  { lesson:36, topic:'vocab-voyage-sur-mesure', type:'choose', q:'越南的首都是？', hint:'課本 p.140', a:'Hanoï', aNote:'⚠️ 當堂以為是胡志明市——那是比較大的城市', opts:['Hanoï','Hô Chi Minh-Ville','Hué','Hoi An'] },
  { lesson:36, topic:'vocab-voyage-sur-mesure', type:'choose', q:'une agence de voyage fait un devis：devis 是？', hint:'課本 p.140 練習6', a:'行程細節和價格（報價單）', aNote:'不是付款確認', opts:['行程細節和價格（報價單）','確認已付款','機票','旅遊保險'] },
  { lesson:36, topic:'vocab-voyage-sur-mesure', type:'choose', q:'décoller 和 atterrir 分別是？', hint:'🎙 開場閒聊（Owen 要飛日本）', a:'起飛／降落', aNote:'名詞 le décollage／l\'atterrissage', opts:['起飛／降落','降落／起飛','登機／下機','訂票／退票'] },
  { lesson:36, topic:'vocab-voyage-sur-mesure', type:'trans', q:'首先…然後…接著…最後…', hint:'課本 p.140 Pour structurer son propos', a:"D'abord… Après… Ensuite… Enfin…", aNote:'寫行程信、講經驗都用這組' },
];
// ── ID 函數 ──
function qId(q) {
