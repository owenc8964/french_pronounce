...
const BANK = [
  ...
  { lesson:27, topic:'pronoms-possessifs', type:'choose', q:'notre 跟 le nôtre 差在哪？', hint:'Owen 當堂問的', a:'代名詞 le nôtre 有帽子，形容詞 notre 沒有；口說幾乎聽不出來', aNote:'⭐ 這是<b>用眼睛的規則</b>：寫的時候一定要分，唸的時候差別非常小。同理 votre → le vôtre', opts:['代名詞 le nôtre 有帽子，形容詞 notre 沒有；口說幾乎聽不出來','兩個發音完全不同','le nôtre 只能用在複數','notre 是舊寫法'] },
