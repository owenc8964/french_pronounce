...
const SENTENCES = [
  ...
  { id: 'S_L25_1', lesson: 25, fr: 'Il y a autant de chambres que dans notre maison.', zh: '房間數跟我們家一樣多。', note: '⭐ 名詞比較要加 de；同等用 autant 不用 aussi' },
  { id: 'S_L25_2', lesson: 25, fr: 'La chambre de Tom est moins grande que la chambre d\'Anna.', zh: 'Tom 的房間比 Anna 的小。', note: '⭐ 形容詞夾在中間：moins ＋ 形容詞 ＋ que' },
  { id: 'S_L25_3', lesson: 25, fr: 'Les jeunes déménagent moins que les personnes âgées.', zh: '年輕人搬家搬得比長輩少。', note: '⭐ 動詞先出現，比較詞跟在後面' },
  { id: 'S_L25_4', lesson: 25, fr: 'On vit bien en ville, mais on vit mieux à la campagne.', zh: '在城市過得不錯，但在鄉下過得更好。', note: '⭐ bien 的優等是 mieux（⛔ 不是 plus bien）' },
  { id: 'S_L25_5', lesson: 25, fr: 'Mon four n\'est pas très bon, je dois acheter un meilleur four.', zh: '我的烤箱不太好，我得買一個更好的。', note: '⭐ bon 的優等是 meilleur（形容詞，要配合性數）' },
  { id: 'S_L25_6', lesson: 25, fr: 'J\'aime mieux ce quartier.', zh: '我更喜歡這一區。', note: '⚠️ aimer 是動詞 → 配 mieux，不是 meilleur' },
  { id: 'S_L25_7', lesson: 25, fr: 'Si je veux lire, je vais à la bibliothèque.', zh: '如果我想看書，我就去圖書館。', note: '⭐ si ＋ 現在式 ＋ 現在式（陳述常態）' },
  { id: 'S_L25_8', lesson: 25, fr: 'Si tu es malade, va à la pharmacie !', zh: '如果你不舒服，就去藥局！', note: '⭐ si ＋ 現在式 ＋ 命令式（語氣更強）' },
  { id: 'S_L25_9', lesson: 25, fr: 'S\'il fait froid, on met le chauffage.', zh: '如果冷，我們就開暖氣。', note: '⚠️ si ＋ il → s\'il；le chauffage＝暖氣，la clim＝冷氣' },
  { id: 'S_L25_10', lesson: 25, fr: 'Ça va aller, t\'inquiète.', zh: '會沒事的，別擔心。', note: '🎙兩句安慰語常連用；t\'inquiète 是省略版，口語專用' },
  { id: 'S_L26_1', lesson: 26, fr: 'Il a le même nez que son père.', zh: '他的鼻子跟他爸一樣。', note: '⭐ 名詞講「相似」：le／la／les même(s) ＋ 名詞 ＋ que' },
  { id: 'S_L26_2', lesson: 26, fr: 'Elle a les mêmes yeux que sa sœur.', zh: '她的眼睛跟她姊姊一樣。', note: 'yeux 複數 → les mêmes（même 要加 s）' },
  { id: 'S_L26_3', lesson: 26, fr: 'Il achète autant de vêtements que moi.', zh: '他買的衣服跟我一樣多。', note: '⭐ 數量相等＋名詞＝autant de。講數量就有 de' },
  { id: 'S_L26_4', lesson: 26, fr: 'Ils parlent autant l\'un que l\'autre.', zh: '他們兩個一樣多話。', note: '⭐ l\'un que l\'autre＝不指名的比較，兩個人都一樣' },
  { id: 'S_L26_5', lesson: 26, fr: 'Ces deux robes sont pareilles.', zh: '這兩件洋裝一樣。', note: '⚠️ pareil 是形容詞要配合性數，而且後面不接 que' },
  { id: 'S_L26_6', lesson: 26, fr: 'Chaque qualité peut cacher un défaut.', zh: '每個優點都可能藏著一個缺點。', note: '⚠️ chaque 永遠不變化＋單數名詞' },
  { id: 'S_L26_7', lesson: 26, fr: 'J\'aime tous les aspects de sa personnalité.', zh: '我喜歡他個性的每一面。', note: '⚠️ tout 要跟名詞配合；tout 跟 tous 唸起來一樣，靠名詞判斷怎麼寫' },
  ...
  { id: 'S_L36_1', lesson: 36, fr: "Pourriez-vous m'expliquer comment faire ?", zh: '您能告訴我要怎麼做嗎？', note: '⭐ 寫信最正式的請求（倒裝＋條件式）' },
  { id: 'S_L36_2', lesson: 36, fr: "J'attends votre réponse avec impatience.", zh: '期待您的回覆。', note: '⭐ 正式信件收尾，DELF／TCF 寫作直接用' },
  { id: 'S_L36_3', lesson: 36, fr: "Je cherche donc quelqu'un avec qui pratiquer cette langue.", zh: '所以我在找人跟我練這個語言。', note: '課本 p.134 原句。avec qui＋原形' },
  { id: 'S_L36_4', lesson: 36, fr: 'Je propose de donner des cours de français contre des cours de chinois.', zh: '我可以教法文，換你教中文。', note: '🎙 老師示範。contre＝用…換' },
  { id: 'S_L36_5', lesson: 36, fr: "Tu m'aiderais à réparer ma voiture, s'il te plaît ?", zh: '你可以幫我修車嗎？', note: '⭐ 條件式＝客氣；futur（aideras）像在逼人' },
  { id: 'S_L36_6', lesson: 36, fr: 'Vous devriez essayer le troc, c\'est très bien !', zh: '你們應該試試以物易物，很不錯！', note: '⭐ devriez＝給建議' },
  { id: 'S_L36_7', lesson: 36, fr: "Mon frigo est en panne.", zh: '我的冰箱壞了（不動了）。', note: '🎙 電器自己停掉用 en panne，摔壞才用 cassé' },
  { id: 'S_L36_8', lesson: 36, fr: 'Ah, je te rejoins.', zh: '啊，我去找你。', note: '🎙 約見面最常用' },
  { id: 'S_L36_9', lesson: 36, fr: "D'abord… Après… Ensuite… Enfin…", zh: '首先…然後…接著…最後…', note: '⭐ 組織一段話的骨架' },
  { id: 'S_L36_10', lesson: 36, fr: "Il était en route vers le Mexique quand il a eu l'idée de créer cette plateforme.", zh: '他在前往墨西哥的路上，突然想到要做這個平台。', note: '⭐⭐ 場景（imparfait）＋quand＋事件（passé composé）的模具' },
  { id: 'S_L36_11', lesson: 36, fr: "Nous étions dans l'avion. Soudain, je me suis senti mal.", zh: '我們在飛機上。突然我覺得不舒服。', note: '⭐ soudain 後面接 passé composé' },
  { id: 'S_L36_12', lesson: 36, fr: "Je me suis blessé au genou, mais ce n'était pas grave.", zh: '我傷到膝蓋，但不嚴重。', note: '⭐ 事件用 PC、評價用 imparfait（ce n\'était pas grave）' },
];
